...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	671040ef          	jal	ra,ffffffffc0204eba <memset>
...
ffffffffc0200056:	eb658593          	addi	a1,a1,-330 # ffffffffc0204f08 <etext>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	ece50513          	addi	a0,a0,-306 # ffffffffc0204f28 <etext+0x20>
...
ffffffffc020007a:	626040ef          	jal	ra,ffffffffc02046a0 <proc_init>
...
ffffffffc020008e:	061040ef          	jal	ra,ffffffffc02048ee <cpu_idle>
...
ffffffffc02000ac:	e8850513          	addi	a0,a0,-376 # ffffffffc0204f30 <etext+0x28>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	149040ef          	jal	ra,ffffffffc0204abc <vprintfmt>
    return cnt;
}
...
ffffffffc02001a8:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001aa:	113040ef          	jal	ra,ffffffffc0204abc <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001ce:	d6e50513          	addi	a0,a0,-658 # ffffffffc0204f38 <etext+0x30>
void print_kerninfo(void) {
...
ffffffffc02001e4:	d7850513          	addi	a0,a0,-648 # ffffffffc0204f58 <etext+0x50>
ffffffffc02001e8:	f99ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ec:	00005597          	auipc	a1,0x5
ffffffffc02001f0:	d1c58593          	addi	a1,a1,-740 # ffffffffc0204f08 <etext>
ffffffffc02001f4:	00005517          	auipc	a0,0x5
ffffffffc02001f8:	d8450513          	addi	a0,a0,-636 # ffffffffc0204f78 <etext+0x70>
...
ffffffffc020020c:	d9050513          	addi	a0,a0,-624 # ffffffffc0204f98 <etext+0x90>
...
ffffffffc0200220:	d9c50513          	addi	a0,a0,-612 # ffffffffc0204fb8 <etext+0xb0>
...
ffffffffc020024e:	d8e50513          	addi	a0,a0,-626 # ffffffffc0204fd8 <etext+0xd0>
}
...
ffffffffc020025c:	db060613          	addi	a2,a2,-592 # ffffffffc0205008 <etext+0x100>
ffffffffc0200260:	04d00593          	li	a1,77
ffffffffc0200264:	00005517          	auipc	a0,0x5
ffffffffc0200268:	dbc50513          	addi	a0,a0,-580 # ffffffffc0205020 <etext+0x118>
void print_stackframe(void) {
...
ffffffffc0200278:	dc460613          	addi	a2,a2,-572 # ffffffffc0205038 <etext+0x130>
ffffffffc020027c:	00005597          	auipc	a1,0x5
ffffffffc0200280:	ddc58593          	addi	a1,a1,-548 # ffffffffc0205058 <etext+0x150>
ffffffffc0200284:	00005517          	auipc	a0,0x5
ffffffffc0200288:	ddc50513          	addi	a0,a0,-548 # ffffffffc0205060 <etext+0x158>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200296:	dde60613          	addi	a2,a2,-546 # ffffffffc0205070 <etext+0x168>
ffffffffc020029a:	00005597          	auipc	a1,0x5
ffffffffc020029e:	dfe58593          	addi	a1,a1,-514 # ffffffffc0205098 <etext+0x190>
ffffffffc02002a2:	00005517          	auipc	a0,0x5
ffffffffc02002a6:	dbe50513          	addi	a0,a0,-578 # ffffffffc0205060 <etext+0x158>
ffffffffc02002aa:	ed7ff0ef          	jal	ra,ffffffffc0200180 <cprintf>
ffffffffc02002ae:	00005617          	auipc	a2,0x5
ffffffffc02002b2:	dfa60613          	addi	a2,a2,-518 # ffffffffc02050a8 <etext+0x1a0>
ffffffffc02002b6:	00005597          	auipc	a1,0x5
ffffffffc02002ba:	e1258593          	addi	a1,a1,-494 # ffffffffc02050c8 <etext+0x1c0>
ffffffffc02002be:	00005517          	auipc	a0,0x5
ffffffffc02002c2:	da250513          	addi	a0,a0,-606 # ffffffffc0205060 <etext+0x158>
...
ffffffffc02002fc:	de050513          	addi	a0,a0,-544 # ffffffffc02050d8 <etext+0x1d0>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031e:	de650513          	addi	a0,a0,-538 # ffffffffc0205100 <etext+0x1f8>
...
ffffffffc0200340:	e34c0c13          	addi	s8,s8,-460 # ffffffffc0205170 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200344:	00005917          	auipc	s2,0x5
ffffffffc0200348:	de490913          	addi	s2,s2,-540 # ffffffffc0205128 <etext+0x220>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc020034c:	00005497          	auipc	s1,0x5
ffffffffc0200350:	de448493          	addi	s1,s1,-540 # ffffffffc0205130 <etext+0x228>
        if (argc == MAXARGS - 1) {
ffffffffc0200354:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200356:	00005b17          	auipc	s6,0x5
ffffffffc020035a:	de2b0b13          	addi	s6,s6,-542 # ffffffffc0205138 <etext+0x230>
        argv[argc ++] = buf;
ffffffffc020035e:	00005a17          	auipc	s4,0x5
ffffffffc0200362:	cfaa0a13          	addi	s4,s4,-774 # ffffffffc0205058 <etext+0x150>
    for (i = 0; i < NCOMMANDS; i ++) {
...
ffffffffc0200384:	df0d0d13          	addi	s10,s10,-528 # ffffffffc0205170 <commands>
        argv[argc ++] = buf;
...
ffffffffc020038c:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc020038e:	2f9040ef          	jal	ra,ffffffffc0204e86 <strcmp>
...
ffffffffc02003a0:	0d61                	addi	s10,s10,24
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc02003a2:	2e5040ef          	jal	ra,ffffffffc0204e86 <strcmp>
...
ffffffffc02003e0:	2c5040ef          	jal	ra,ffffffffc0204ea4 <strchr>
...
ffffffffc020041e:	287040ef          	jal	ra,ffffffffc0204ea4 <strchr>
...
ffffffffc020043c:	d2050513          	addi	a0,a0,-736 # ffffffffc0205158 <etext+0x250>
...
ffffffffc0200478:	d4450513          	addi	a0,a0,-700 # ffffffffc02051b8 <commands+0x48>
    va_start(ap, fmt);
...
ffffffffc020048e:	c9e50513          	addi	a0,a0,-866 # ffffffffc0206128 <default_pmm_manager+0x4d0>
...
ffffffffc02004cc:	d1050513          	addi	a0,a0,-752 # ffffffffc02051d8 <commands+0x68>
    ticks = 0;
...
ffffffffc020058a:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020058c:	141040ef          	jal	ra,ffffffffc0204ecc <memcpy>
    return 0;
}
...
ffffffffc02005ae:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc02005b0:	11d040ef          	jal	ra,ffffffffc0204ecc <memcpy>
    return 0;
}
...
ffffffffc02005fe:	bfe50513          	addi	a0,a0,-1026 # ffffffffc02051f8 <commands+0x88>
...
ffffffffc0200626:	bf660613          	addi	a2,a2,-1034 # ffffffffc0205218 <commands+0xa8>
ffffffffc020062a:	06200593          	li	a1,98
ffffffffc020062e:	00005517          	auipc	a0,0x5
ffffffffc0200632:	c0250513          	addi	a0,a0,-1022 # ffffffffc0205230 <commands+0xc0>
...
ffffffffc0200660:	bec50513          	addi	a0,a0,-1044 # ffffffffc0205248 <commands+0xd8>
void print_regs(struct pushregs *gpr) {
...
ffffffffc0200670:	bf450513          	addi	a0,a0,-1036 # ffffffffc0205260 <commands+0xf0>
...
ffffffffc020067e:	bfe50513          	addi	a0,a0,-1026 # ffffffffc0205278 <commands+0x108>
...
ffffffffc020068c:	c0850513          	addi	a0,a0,-1016 # ffffffffc0205290 <commands+0x120>
...
ffffffffc020069a:	c1250513          	addi	a0,a0,-1006 # ffffffffc02052a8 <commands+0x138>
...
ffffffffc02006a8:	c1c50513          	addi	a0,a0,-996 # ffffffffc02052c0 <commands+0x150>
...
ffffffffc02006b6:	c2650513          	addi	a0,a0,-986 # ffffffffc02052d8 <commands+0x168>
...
ffffffffc02006c4:	c3050513          	addi	a0,a0,-976 # ffffffffc02052f0 <commands+0x180>
...
ffffffffc02006d2:	c3a50513          	addi	a0,a0,-966 # ffffffffc0205308 <commands+0x198>
...
ffffffffc02006e0:	c4450513          	addi	a0,a0,-956 # ffffffffc0205320 <commands+0x1b0>
...
ffffffffc02006ee:	c4e50513          	addi	a0,a0,-946 # ffffffffc0205338 <commands+0x1c8>
...
ffffffffc02006fc:	c5850513          	addi	a0,a0,-936 # ffffffffc0205350 <commands+0x1e0>
...
ffffffffc020070a:	c6250513          	addi	a0,a0,-926 # ffffffffc0205368 <commands+0x1f8>
...
ffffffffc0200718:	c6c50513          	addi	a0,a0,-916 # ffffffffc0205380 <commands+0x210>
...
ffffffffc0200726:	c7650513          	addi	a0,a0,-906 # ffffffffc0205398 <commands+0x228>
...
ffffffffc0200734:	c8050513          	addi	a0,a0,-896 # ffffffffc02053b0 <commands+0x240>
...
ffffffffc0200742:	c8a50513          	addi	a0,a0,-886 # ffffffffc02053c8 <commands+0x258>
...
ffffffffc0200750:	c9450513          	addi	a0,a0,-876 # ffffffffc02053e0 <commands+0x270>
...
ffffffffc020075e:	c9e50513          	addi	a0,a0,-866 # ffffffffc02053f8 <commands+0x288>
...
ffffffffc020076c:	ca850513          	addi	a0,a0,-856 # ffffffffc0205410 <commands+0x2a0>
...
ffffffffc020077a:	cb250513          	addi	a0,a0,-846 # ffffffffc0205428 <commands+0x2b8>
...
ffffffffc0200788:	cbc50513          	addi	a0,a0,-836 # ffffffffc0205440 <commands+0x2d0>
...
ffffffffc0200796:	cc650513          	addi	a0,a0,-826 # ffffffffc0205458 <commands+0x2e8>
...
ffffffffc02007a4:	cd050513          	addi	a0,a0,-816 # ffffffffc0205470 <commands+0x300>
...
ffffffffc02007b2:	cda50513          	addi	a0,a0,-806 # ffffffffc0205488 <commands+0x318>
ffffffffc02007b6:	9cbff0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("  s9       0x%08x\n", gpr->s9);
ffffffffc02007ba:	646c                	ld	a1,200(s0)
ffffffffc02007bc:	00005517          	auipc	a0,0x5
ffffffffc02007c0:	ce450513          	addi	a0,a0,-796 # ffffffffc02054a0 <commands+0x330>
...
ffffffffc02007ce:	cee50513          	addi	a0,a0,-786 # ffffffffc02054b8 <commands+0x348>
...
ffffffffc02007dc:	cf850513          	addi	a0,a0,-776 # ffffffffc02054d0 <commands+0x360>
...
ffffffffc02007ea:	d0250513          	addi	a0,a0,-766 # ffffffffc02054e8 <commands+0x378>
...
ffffffffc02007f8:	d0c50513          	addi	a0,a0,-756 # ffffffffc0205500 <commands+0x390>
...
ffffffffc0200806:	d1650513          	addi	a0,a0,-746 # ffffffffc0205518 <commands+0x3a8>
...
ffffffffc0200818:	d1c50513          	addi	a0,a0,-740 # ffffffffc0205530 <commands+0x3c0>
}
...
ffffffffc020082c:	d2050513          	addi	a0,a0,-736 # ffffffffc0205548 <commands+0x3d8>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200844:	d2050513          	addi	a0,a0,-736 # ffffffffc0205560 <commands+0x3f0>
...
ffffffffc0200854:	d2850513          	addi	a0,a0,-728 # ffffffffc0205578 <commands+0x408>
...
ffffffffc0200864:	d3050513          	addi	a0,a0,-720 # ffffffffc0205590 <commands+0x420>
...
ffffffffc0200878:	d3450513          	addi	a0,a0,-716 # ffffffffc02055a8 <commands+0x438>
}
...
ffffffffc0200894:	de070713          	addi	a4,a4,-544 # ffffffffc0205670 <commands+0x500>
...
ffffffffc02008a6:	d7e50513          	addi	a0,a0,-642 # ffffffffc0205620 <commands+0x4b0>
ffffffffc02008aa:	8d7ff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Hypervisor software interrupt\n");
ffffffffc02008ae:	00005517          	auipc	a0,0x5
ffffffffc02008b2:	d5250513          	addi	a0,a0,-686 # ffffffffc0205600 <commands+0x490>
ffffffffc02008b6:	8cbff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("User software interrupt\n");
ffffffffc02008ba:	00005517          	auipc	a0,0x5
ffffffffc02008be:	d0650513          	addi	a0,a0,-762 # ffffffffc02055c0 <commands+0x450>
ffffffffc02008c2:	8bfff06f          	j	ffffffffc0200180 <cprintf>
            cprintf("Supervisor software interrupt\n");
ffffffffc02008c6:	00005517          	auipc	a0,0x5
ffffffffc02008ca:	d1a50513          	addi	a0,a0,-742 # ffffffffc02055e0 <commands+0x470>
...
ffffffffc02008fc:	d5850513          	addi	a0,a0,-680 # ffffffffc0205650 <commands+0x4e0>
...
ffffffffc0200910:	d3450513          	addi	a0,a0,-716 # ffffffffc0205640 <commands+0x4d0>
}
...
ffffffffc0200932:	f2a70713          	addi	a4,a4,-214 # ffffffffc0205858 <commands+0x6e8>
...
ffffffffc0200944:	f0050513          	addi	a0,a0,-256 # ffffffffc0205840 <commands+0x6d0>
...
ffffffffc0200966:	d3e50513          	addi	a0,a0,-706 # ffffffffc02056a0 <commands+0x530>
}
...
ffffffffc02009c0:	d8460613          	addi	a2,a2,-636 # ffffffffc0205740 <commands+0x5d0>
ffffffffc02009c4:	0b300593          	li	a1,179
ffffffffc02009c8:	00005517          	auipc	a0,0x5
ffffffffc02009cc:	86850513          	addi	a0,a0,-1944 # ffffffffc0205230 <commands+0xc0>
ffffffffc02009d0:	a77ff0ef          	jal	ra,ffffffffc0200446 <__panic>
            cprintf("AMO address misaligned\n");
ffffffffc02009d4:	00005517          	auipc	a0,0x5
ffffffffc02009d8:	d8c50513          	addi	a0,a0,-628 # ffffffffc0205760 <commands+0x5f0>
ffffffffc02009dc:	b779                	j	ffffffffc020096a <exception_handler+0x50>
            cprintf("Store/AMO access fault\n");
ffffffffc02009de:	00005517          	auipc	a0,0x5
ffffffffc02009e2:	d9a50513          	addi	a0,a0,-614 # ffffffffc0205778 <commands+0x608>
...
ffffffffc0200a6a:	cda60613          	addi	a2,a2,-806 # ffffffffc0205740 <commands+0x5d0>
ffffffffc0200a6e:	0d300593          	li	a1,211
ffffffffc0200a72:	00004517          	auipc	a0,0x4
ffffffffc0200a76:	7be50513          	addi	a0,a0,1982 # ffffffffc0205230 <commands+0xc0>
...
ffffffffc0200a96:	cae60613          	addi	a2,a2,-850 # ffffffffc0205740 <commands+0x5d0>
ffffffffc0200a9a:	0da00593          	li	a1,218
ffffffffc0200a9e:	00004517          	auipc	a0,0x4
ffffffffc0200aa2:	79250513          	addi	a0,a0,1938 # ffffffffc0205230 <commands+0xc0>
...
ffffffffc0200c2e:	3be63603          	ld	a2,958(a2) # ffffffffc0206fe8 <nbase>
...
ffffffffc0200e74:	a2868693          	addi	a3,a3,-1496 # ffffffffc0205898 <commands+0x728>
ffffffffc0200e78:	00005617          	auipc	a2,0x5
ffffffffc0200e7c:	a3060613          	addi	a2,a2,-1488 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200e80:	0f000593          	li	a1,240
ffffffffc0200e84:	00005517          	auipc	a0,0x5
ffffffffc0200e88:	a3c50513          	addi	a0,a0,-1476 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200e8c:	dbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e90:	00005697          	auipc	a3,0x5
ffffffffc0200e94:	ac868693          	addi	a3,a3,-1336 # ffffffffc0205958 <commands+0x7e8>
ffffffffc0200e98:	00005617          	auipc	a2,0x5
ffffffffc0200e9c:	a1060613          	addi	a2,a2,-1520 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200ea0:	0bd00593          	li	a1,189
ffffffffc0200ea4:	00005517          	auipc	a0,0x5
ffffffffc0200ea8:	a1c50513          	addi	a0,a0,-1508 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200eac:	d9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200eb0:	00005697          	auipc	a3,0x5
ffffffffc0200eb4:	ad068693          	addi	a3,a3,-1328 # ffffffffc0205980 <commands+0x810>
ffffffffc0200eb8:	00005617          	auipc	a2,0x5
ffffffffc0200ebc:	9f060613          	addi	a2,a2,-1552 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200ec0:	0be00593          	li	a1,190
ffffffffc0200ec4:	00005517          	auipc	a0,0x5
ffffffffc0200ec8:	9fc50513          	addi	a0,a0,-1540 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200ecc:	d7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ed0:	00005697          	auipc	a3,0x5
ffffffffc0200ed4:	af068693          	addi	a3,a3,-1296 # ffffffffc02059c0 <commands+0x850>
ffffffffc0200ed8:	00005617          	auipc	a2,0x5
ffffffffc0200edc:	9d060613          	addi	a2,a2,-1584 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200ee0:	0c000593          	li	a1,192
ffffffffc0200ee4:	00005517          	auipc	a0,0x5
ffffffffc0200ee8:	9dc50513          	addi	a0,a0,-1572 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200eec:	d5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ef0:	00005697          	auipc	a3,0x5
ffffffffc0200ef4:	b5868693          	addi	a3,a3,-1192 # ffffffffc0205a48 <commands+0x8d8>
ffffffffc0200ef8:	00005617          	auipc	a2,0x5
ffffffffc0200efc:	9b060613          	addi	a2,a2,-1616 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200f00:	0d900593          	li	a1,217
ffffffffc0200f04:	00005517          	auipc	a0,0x5
ffffffffc0200f08:	9bc50513          	addi	a0,a0,-1604 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200f0c:	d3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f10:	00005697          	auipc	a3,0x5
ffffffffc0200f14:	9e868693          	addi	a3,a3,-1560 # ffffffffc02058f8 <commands+0x788>
ffffffffc0200f18:	00005617          	auipc	a2,0x5
ffffffffc0200f1c:	99060613          	addi	a2,a2,-1648 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200f20:	0d200593          	li	a1,210
ffffffffc0200f24:	00005517          	auipc	a0,0x5
ffffffffc0200f28:	99c50513          	addi	a0,a0,-1636 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200f2c:	d1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 3);
ffffffffc0200f30:	00005697          	auipc	a3,0x5
ffffffffc0200f34:	b0868693          	addi	a3,a3,-1272 # ffffffffc0205a38 <commands+0x8c8>
ffffffffc0200f38:	00005617          	auipc	a2,0x5
ffffffffc0200f3c:	97060613          	addi	a2,a2,-1680 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200f40:	0d000593          	li	a1,208
ffffffffc0200f44:	00005517          	auipc	a0,0x5
ffffffffc0200f48:	97c50513          	addi	a0,a0,-1668 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200f4c:	cfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f50:	00005697          	auipc	a3,0x5
ffffffffc0200f54:	ad068693          	addi	a3,a3,-1328 # ffffffffc0205a20 <commands+0x8b0>
ffffffffc0200f58:	00005617          	auipc	a2,0x5
ffffffffc0200f5c:	95060613          	addi	a2,a2,-1712 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200f60:	0cb00593          	li	a1,203
ffffffffc0200f64:	00005517          	auipc	a0,0x5
ffffffffc0200f68:	95c50513          	addi	a0,a0,-1700 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200f6c:	cdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f70:	00005697          	auipc	a3,0x5
ffffffffc0200f74:	a9068693          	addi	a3,a3,-1392 # ffffffffc0205a00 <commands+0x890>
ffffffffc0200f78:	00005617          	auipc	a2,0x5
ffffffffc0200f7c:	93060613          	addi	a2,a2,-1744 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200f80:	0c200593          	li	a1,194
ffffffffc0200f84:	00005517          	auipc	a0,0x5
ffffffffc0200f88:	93c50513          	addi	a0,a0,-1732 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200f8c:	cbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 != NULL);
ffffffffc0200f90:	00005697          	auipc	a3,0x5
ffffffffc0200f94:	b0068693          	addi	a3,a3,-1280 # ffffffffc0205a90 <commands+0x920>
ffffffffc0200f98:	00005617          	auipc	a2,0x5
ffffffffc0200f9c:	91060613          	addi	a2,a2,-1776 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200fa0:	0f800593          	li	a1,248
ffffffffc0200fa4:	00005517          	auipc	a0,0x5
ffffffffc0200fa8:	91c50513          	addi	a0,a0,-1764 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200fac:	c9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc0200fb0:	00005697          	auipc	a3,0x5
ffffffffc0200fb4:	ad068693          	addi	a3,a3,-1328 # ffffffffc0205a80 <commands+0x910>
ffffffffc0200fb8:	00005617          	auipc	a2,0x5
ffffffffc0200fbc:	8f060613          	addi	a2,a2,-1808 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200fc0:	0df00593          	li	a1,223
ffffffffc0200fc4:	00005517          	auipc	a0,0x5
ffffffffc0200fc8:	8fc50513          	addi	a0,a0,-1796 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200fcc:	c7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fd0:	00005697          	auipc	a3,0x5
ffffffffc0200fd4:	a5068693          	addi	a3,a3,-1456 # ffffffffc0205a20 <commands+0x8b0>
ffffffffc0200fd8:	00005617          	auipc	a2,0x5
ffffffffc0200fdc:	8d060613          	addi	a2,a2,-1840 # ffffffffc02058a8 <commands+0x738>
ffffffffc0200fe0:	0dd00593          	li	a1,221
ffffffffc0200fe4:	00005517          	auipc	a0,0x5
ffffffffc0200fe8:	8dc50513          	addi	a0,a0,-1828 # ffffffffc02058c0 <commands+0x750>
ffffffffc0200fec:	c5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200ff0:	00005697          	auipc	a3,0x5
ffffffffc0200ff4:	a7068693          	addi	a3,a3,-1424 # ffffffffc0205a60 <commands+0x8f0>
ffffffffc0200ff8:	00005617          	auipc	a2,0x5
ffffffffc0200ffc:	8b060613          	addi	a2,a2,-1872 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201000:	0dc00593          	li	a1,220
ffffffffc0201004:	00005517          	auipc	a0,0x5
ffffffffc0201008:	8bc50513          	addi	a0,a0,-1860 # ffffffffc02058c0 <commands+0x750>
ffffffffc020100c:	c3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201010:	00005697          	auipc	a3,0x5
ffffffffc0201014:	8e868693          	addi	a3,a3,-1816 # ffffffffc02058f8 <commands+0x788>
ffffffffc0201018:	00005617          	auipc	a2,0x5
ffffffffc020101c:	89060613          	addi	a2,a2,-1904 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201020:	0b900593          	li	a1,185
ffffffffc0201024:	00005517          	auipc	a0,0x5
ffffffffc0201028:	89c50513          	addi	a0,a0,-1892 # ffffffffc02058c0 <commands+0x750>
ffffffffc020102c:	c1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201030:	00005697          	auipc	a3,0x5
ffffffffc0201034:	9f068693          	addi	a3,a3,-1552 # ffffffffc0205a20 <commands+0x8b0>
ffffffffc0201038:	00005617          	auipc	a2,0x5
ffffffffc020103c:	87060613          	addi	a2,a2,-1936 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201040:	0d600593          	li	a1,214
ffffffffc0201044:	00005517          	auipc	a0,0x5
ffffffffc0201048:	87c50513          	addi	a0,a0,-1924 # ffffffffc02058c0 <commands+0x750>
ffffffffc020104c:	bfaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201050:	00005697          	auipc	a3,0x5
ffffffffc0201054:	8e868693          	addi	a3,a3,-1816 # ffffffffc0205938 <commands+0x7c8>
ffffffffc0201058:	00005617          	auipc	a2,0x5
ffffffffc020105c:	85060613          	addi	a2,a2,-1968 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201060:	0d400593          	li	a1,212
ffffffffc0201064:	00005517          	auipc	a0,0x5
ffffffffc0201068:	85c50513          	addi	a0,a0,-1956 # ffffffffc02058c0 <commands+0x750>
ffffffffc020106c:	bdaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201070:	00005697          	auipc	a3,0x5
ffffffffc0201074:	8a868693          	addi	a3,a3,-1880 # ffffffffc0205918 <commands+0x7a8>
ffffffffc0201078:	00005617          	auipc	a2,0x5
ffffffffc020107c:	83060613          	addi	a2,a2,-2000 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201080:	0d300593          	li	a1,211
ffffffffc0201084:	00005517          	auipc	a0,0x5
ffffffffc0201088:	83c50513          	addi	a0,a0,-1988 # ffffffffc02058c0 <commands+0x750>
ffffffffc020108c:	bbaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201090:	00005697          	auipc	a3,0x5
ffffffffc0201094:	8a868693          	addi	a3,a3,-1880 # ffffffffc0205938 <commands+0x7c8>
ffffffffc0201098:	00005617          	auipc	a2,0x5
ffffffffc020109c:	81060613          	addi	a2,a2,-2032 # ffffffffc02058a8 <commands+0x738>
ffffffffc02010a0:	0bb00593          	li	a1,187
ffffffffc02010a4:	00005517          	auipc	a0,0x5
ffffffffc02010a8:	81c50513          	addi	a0,a0,-2020 # ffffffffc02058c0 <commands+0x750>
ffffffffc02010ac:	b9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(count == 0);
ffffffffc02010b0:	00005697          	auipc	a3,0x5
ffffffffc02010b4:	b3068693          	addi	a3,a3,-1232 # ffffffffc0205be0 <commands+0xa70>
ffffffffc02010b8:	00004617          	auipc	a2,0x4
ffffffffc02010bc:	7f060613          	addi	a2,a2,2032 # ffffffffc02058a8 <commands+0x738>
ffffffffc02010c0:	12500593          	li	a1,293
ffffffffc02010c4:	00004517          	auipc	a0,0x4
ffffffffc02010c8:	7fc50513          	addi	a0,a0,2044 # ffffffffc02058c0 <commands+0x750>
ffffffffc02010cc:	b7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free == 0);
ffffffffc02010d0:	00005697          	auipc	a3,0x5
ffffffffc02010d4:	9b068693          	addi	a3,a3,-1616 # ffffffffc0205a80 <commands+0x910>
ffffffffc02010d8:	00004617          	auipc	a2,0x4
ffffffffc02010dc:	7d060613          	addi	a2,a2,2000 # ffffffffc02058a8 <commands+0x738>
ffffffffc02010e0:	11a00593          	li	a1,282
ffffffffc02010e4:	00004517          	auipc	a0,0x4
ffffffffc02010e8:	7dc50513          	addi	a0,a0,2012 # ffffffffc02058c0 <commands+0x750>
ffffffffc02010ec:	b5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010f0:	00005697          	auipc	a3,0x5
ffffffffc02010f4:	93068693          	addi	a3,a3,-1744 # ffffffffc0205a20 <commands+0x8b0>
ffffffffc02010f8:	00004617          	auipc	a2,0x4
ffffffffc02010fc:	7b060613          	addi	a2,a2,1968 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201100:	11800593          	li	a1,280
ffffffffc0201104:	00004517          	auipc	a0,0x4
ffffffffc0201108:	7bc50513          	addi	a0,a0,1980 # ffffffffc02058c0 <commands+0x750>
ffffffffc020110c:	b3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201110:	00005697          	auipc	a3,0x5
ffffffffc0201114:	8d068693          	addi	a3,a3,-1840 # ffffffffc02059e0 <commands+0x870>
ffffffffc0201118:	00004617          	auipc	a2,0x4
ffffffffc020111c:	79060613          	addi	a2,a2,1936 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201120:	0c100593          	li	a1,193
ffffffffc0201124:	00004517          	auipc	a0,0x4
ffffffffc0201128:	79c50513          	addi	a0,a0,1948 # ffffffffc02058c0 <commands+0x750>
ffffffffc020112c:	b1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201130:	00005697          	auipc	a3,0x5
ffffffffc0201134:	a7068693          	addi	a3,a3,-1424 # ffffffffc0205ba0 <commands+0xa30>
ffffffffc0201138:	00004617          	auipc	a2,0x4
ffffffffc020113c:	77060613          	addi	a2,a2,1904 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201140:	11200593          	li	a1,274
ffffffffc0201144:	00004517          	auipc	a0,0x4
ffffffffc0201148:	77c50513          	addi	a0,a0,1916 # ffffffffc02058c0 <commands+0x750>
ffffffffc020114c:	afaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201150:	00005697          	auipc	a3,0x5
ffffffffc0201154:	a3068693          	addi	a3,a3,-1488 # ffffffffc0205b80 <commands+0xa10>
ffffffffc0201158:	00004617          	auipc	a2,0x4
ffffffffc020115c:	75060613          	addi	a2,a2,1872 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201160:	11000593          	li	a1,272
ffffffffc0201164:	00004517          	auipc	a0,0x4
ffffffffc0201168:	75c50513          	addi	a0,a0,1884 # ffffffffc02058c0 <commands+0x750>
ffffffffc020116c:	adaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201170:	00005697          	auipc	a3,0x5
ffffffffc0201174:	9e868693          	addi	a3,a3,-1560 # ffffffffc0205b58 <commands+0x9e8>
ffffffffc0201178:	00004617          	auipc	a2,0x4
ffffffffc020117c:	73060613          	addi	a2,a2,1840 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201180:	10e00593          	li	a1,270
ffffffffc0201184:	00004517          	auipc	a0,0x4
ffffffffc0201188:	73c50513          	addi	a0,a0,1852 # ffffffffc02058c0 <commands+0x750>
ffffffffc020118c:	abaff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201190:	00005697          	auipc	a3,0x5
ffffffffc0201194:	9a068693          	addi	a3,a3,-1632 # ffffffffc0205b30 <commands+0x9c0>
ffffffffc0201198:	00004617          	auipc	a2,0x4
ffffffffc020119c:	71060613          	addi	a2,a2,1808 # ffffffffc02058a8 <commands+0x738>
ffffffffc02011a0:	10d00593          	li	a1,269
ffffffffc02011a4:	00004517          	auipc	a0,0x4
ffffffffc02011a8:	71c50513          	addi	a0,a0,1820 # ffffffffc02058c0 <commands+0x750>
ffffffffc02011ac:	a9aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011b0:	00005697          	auipc	a3,0x5
ffffffffc02011b4:	97068693          	addi	a3,a3,-1680 # ffffffffc0205b20 <commands+0x9b0>
ffffffffc02011b8:	00004617          	auipc	a2,0x4
ffffffffc02011bc:	6f060613          	addi	a2,a2,1776 # ffffffffc02058a8 <commands+0x738>
ffffffffc02011c0:	10800593          	li	a1,264
ffffffffc02011c4:	00004517          	auipc	a0,0x4
ffffffffc02011c8:	6fc50513          	addi	a0,a0,1788 # ffffffffc02058c0 <commands+0x750>
ffffffffc02011cc:	a7aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011d0:	00005697          	auipc	a3,0x5
ffffffffc02011d4:	85068693          	addi	a3,a3,-1968 # ffffffffc0205a20 <commands+0x8b0>
ffffffffc02011d8:	00004617          	auipc	a2,0x4
ffffffffc02011dc:	6d060613          	addi	a2,a2,1744 # ffffffffc02058a8 <commands+0x738>
ffffffffc02011e0:	10700593          	li	a1,263
ffffffffc02011e4:	00004517          	auipc	a0,0x4
ffffffffc02011e8:	6dc50513          	addi	a0,a0,1756 # ffffffffc02058c0 <commands+0x750>
ffffffffc02011ec:	a5aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011f0:	00005697          	auipc	a3,0x5
ffffffffc02011f4:	91068693          	addi	a3,a3,-1776 # ffffffffc0205b00 <commands+0x990>
ffffffffc02011f8:	00004617          	auipc	a2,0x4
ffffffffc02011fc:	6b060613          	addi	a2,a2,1712 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201200:	10600593          	li	a1,262
ffffffffc0201204:	00004517          	auipc	a0,0x4
ffffffffc0201208:	6bc50513          	addi	a0,a0,1724 # ffffffffc02058c0 <commands+0x750>
ffffffffc020120c:	a3aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201210:	00005697          	auipc	a3,0x5
ffffffffc0201214:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205ad0 <commands+0x960>
ffffffffc0201218:	00004617          	auipc	a2,0x4
ffffffffc020121c:	69060613          	addi	a2,a2,1680 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201220:	10500593          	li	a1,261
ffffffffc0201224:	00004517          	auipc	a0,0x4
ffffffffc0201228:	69c50513          	addi	a0,a0,1692 # ffffffffc02058c0 <commands+0x750>
ffffffffc020122c:	a1aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201230:	00005697          	auipc	a3,0x5
ffffffffc0201234:	88868693          	addi	a3,a3,-1912 # ffffffffc0205ab8 <commands+0x948>
ffffffffc0201238:	00004617          	auipc	a2,0x4
ffffffffc020123c:	67060613          	addi	a2,a2,1648 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201240:	10400593          	li	a1,260
ffffffffc0201244:	00004517          	auipc	a0,0x4
ffffffffc0201248:	67c50513          	addi	a0,a0,1660 # ffffffffc02058c0 <commands+0x750>
ffffffffc020124c:	9faff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201250:	00004697          	auipc	a3,0x4
ffffffffc0201254:	7d068693          	addi	a3,a3,2000 # ffffffffc0205a20 <commands+0x8b0>
ffffffffc0201258:	00004617          	auipc	a2,0x4
ffffffffc020125c:	65060613          	addi	a2,a2,1616 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201260:	0fe00593          	li	a1,254
ffffffffc0201264:	00004517          	auipc	a0,0x4
ffffffffc0201268:	65c50513          	addi	a0,a0,1628 # ffffffffc02058c0 <commands+0x750>
ffffffffc020126c:	9daff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201270:	00005697          	auipc	a3,0x5
ffffffffc0201274:	83068693          	addi	a3,a3,-2000 # ffffffffc0205aa0 <commands+0x930>
ffffffffc0201278:	00004617          	auipc	a2,0x4
ffffffffc020127c:	63060613          	addi	a2,a2,1584 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201280:	0f900593          	li	a1,249
ffffffffc0201284:	00004517          	auipc	a0,0x4
ffffffffc0201288:	63c50513          	addi	a0,a0,1596 # ffffffffc02058c0 <commands+0x750>
ffffffffc020128c:	9baff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201290:	00005697          	auipc	a3,0x5
ffffffffc0201294:	93068693          	addi	a3,a3,-1744 # ffffffffc0205bc0 <commands+0xa50>
ffffffffc0201298:	00004617          	auipc	a2,0x4
ffffffffc020129c:	61060613          	addi	a2,a2,1552 # ffffffffc02058a8 <commands+0x738>
ffffffffc02012a0:	11700593          	li	a1,279
ffffffffc02012a4:	00004517          	auipc	a0,0x4
ffffffffc02012a8:	61c50513          	addi	a0,a0,1564 # ffffffffc02058c0 <commands+0x750>
ffffffffc02012ac:	99aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == 0);
ffffffffc02012b0:	00005697          	auipc	a3,0x5
ffffffffc02012b4:	94068693          	addi	a3,a3,-1728 # ffffffffc0205bf0 <commands+0xa80>
ffffffffc02012b8:	00004617          	auipc	a2,0x4
ffffffffc02012bc:	5f060613          	addi	a2,a2,1520 # ffffffffc02058a8 <commands+0x738>
ffffffffc02012c0:	12600593          	li	a1,294
ffffffffc02012c4:	00004517          	auipc	a0,0x4
ffffffffc02012c8:	5fc50513          	addi	a0,a0,1532 # ffffffffc02058c0 <commands+0x750>
ffffffffc02012cc:	97aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012d0:	00004697          	auipc	a3,0x4
ffffffffc02012d4:	60868693          	addi	a3,a3,1544 # ffffffffc02058d8 <commands+0x768>
ffffffffc02012d8:	00004617          	auipc	a2,0x4
ffffffffc02012dc:	5d060613          	addi	a2,a2,1488 # ffffffffc02058a8 <commands+0x738>
ffffffffc02012e0:	0f300593          	li	a1,243
ffffffffc02012e4:	00004517          	auipc	a0,0x4
ffffffffc02012e8:	5dc50513          	addi	a0,a0,1500 # ffffffffc02058c0 <commands+0x750>
ffffffffc02012ec:	95aff0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012f0:	00004697          	auipc	a3,0x4
ffffffffc02012f4:	62868693          	addi	a3,a3,1576 # ffffffffc0205918 <commands+0x7a8>
ffffffffc02012f8:	00004617          	auipc	a2,0x4
ffffffffc02012fc:	5b060613          	addi	a2,a2,1456 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201300:	0ba00593          	li	a1,186
ffffffffc0201304:	00004517          	auipc	a0,0x4
ffffffffc0201308:	5bc50513          	addi	a0,a0,1468 # ffffffffc02058c0 <commands+0x750>
...
ffffffffc0201440:	7cc68693          	addi	a3,a3,1996 # ffffffffc0205c08 <commands+0xa98>
ffffffffc0201444:	00004617          	auipc	a2,0x4
ffffffffc0201448:	46460613          	addi	a2,a2,1124 # ffffffffc02058a8 <commands+0x738>
ffffffffc020144c:	08300593          	li	a1,131
ffffffffc0201450:	00004517          	auipc	a0,0x4
ffffffffc0201454:	47050513          	addi	a0,a0,1136 # ffffffffc02058c0 <commands+0x750>
ffffffffc0201458:	feffe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc020145c:	00004697          	auipc	a3,0x4
ffffffffc0201460:	7a468693          	addi	a3,a3,1956 # ffffffffc0205c00 <commands+0xa90>
ffffffffc0201464:	00004617          	auipc	a2,0x4
ffffffffc0201468:	44460613          	addi	a2,a2,1092 # ffffffffc02058a8 <commands+0x738>
ffffffffc020146c:	08000593          	li	a1,128
ffffffffc0201470:	00004517          	auipc	a0,0x4
ffffffffc0201474:	45050513          	addi	a0,a0,1104 # ffffffffc02058c0 <commands+0x750>
...
ffffffffc0201512:	6f268693          	addi	a3,a3,1778 # ffffffffc0205c00 <commands+0xa90>
ffffffffc0201516:	00004617          	auipc	a2,0x4
ffffffffc020151a:	39260613          	addi	a2,a2,914 # ffffffffc02058a8 <commands+0x738>
ffffffffc020151e:	06200593          	li	a1,98
ffffffffc0201522:	00004517          	auipc	a0,0x4
ffffffffc0201526:	39e50513          	addi	a0,a0,926 # ffffffffc02058c0 <commands+0x750>
default_alloc_pages(size_t n) {
...
ffffffffc02015e4:	65068693          	addi	a3,a3,1616 # ffffffffc0205c30 <commands+0xac0>
ffffffffc02015e8:	00004617          	auipc	a2,0x4
ffffffffc02015ec:	2c060613          	addi	a2,a2,704 # ffffffffc02058a8 <commands+0x738>
ffffffffc02015f0:	04900593          	li	a1,73
ffffffffc02015f4:	00004517          	auipc	a0,0x4
ffffffffc02015f8:	2cc50513          	addi	a0,a0,716 # ffffffffc02058c0 <commands+0x750>
ffffffffc02015fc:	e4bfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(n > 0);
ffffffffc0201600:	00004697          	auipc	a3,0x4
ffffffffc0201604:	60068693          	addi	a3,a3,1536 # ffffffffc0205c00 <commands+0xa90>
ffffffffc0201608:	00004617          	auipc	a2,0x4
ffffffffc020160c:	2a060613          	addi	a2,a2,672 # ffffffffc02058a8 <commands+0x738>
ffffffffc0201610:	04600593          	li	a1,70
ffffffffc0201614:	00004517          	auipc	a0,0x4
ffffffffc0201618:	2ac50513          	addi	a0,a0,684 # ffffffffc02058c0 <commands+0x750>
...
ffffffffc02016f4:	8f86b683          	ld	a3,-1800(a3) # ffffffffc0206fe8 <nbase>
...
ffffffffc0201724:	57060613          	addi	a2,a2,1392 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0201728:	06900593          	li	a1,105
ffffffffc020172c:	00004517          	auipc	a0,0x4
ffffffffc0201730:	58c50513          	addi	a0,a0,1420 # ffffffffc0205cb8 <default_pmm_manager+0x60>
...
ffffffffc0201812:	4ba68693          	addi	a3,a3,1210 # ffffffffc0205cc8 <default_pmm_manager+0x70>
ffffffffc0201816:	00004617          	auipc	a2,0x4
ffffffffc020181a:	09260613          	addi	a2,a2,146 # ffffffffc02058a8 <commands+0x738>
ffffffffc020181e:	06300593          	li	a1,99
ffffffffc0201822:	00004517          	auipc	a0,0x4
ffffffffc0201826:	4c650513          	addi	a0,a0,1222 # ffffffffc0205ce8 <default_pmm_manager+0x90>
...
ffffffffc0201834:	4d050513          	addi	a0,a0,1232 # ffffffffc0205d00 <default_pmm_manager+0xa8>
kmalloc_init(void) {
...
ffffffffc0201844:	4d850513          	addi	a0,a0,1240 # ffffffffc0205d18 <default_pmm_manager+0xc0>
}
...
ffffffffc0201968:	68453503          	ld	a0,1668(a0) # ffffffffc0206fe8 <nbase>
...
ffffffffc02019c6:	39e60613          	addi	a2,a2,926 # ffffffffc0205d60 <default_pmm_manager+0x108>
ffffffffc02019ca:	06200593          	li	a1,98
ffffffffc02019ce:	00004517          	auipc	a0,0x4
ffffffffc02019d2:	2ea50513          	addi	a0,a0,746 # ffffffffc0205cb8 <default_pmm_manager+0x60>
...
ffffffffc02019e0:	35c60613          	addi	a2,a2,860 # ffffffffc0205d38 <default_pmm_manager+0xe0>
ffffffffc02019e4:	06e00593          	li	a1,110
ffffffffc02019e8:	00004517          	auipc	a0,0x4
ffffffffc02019ec:	2d050513          	addi	a0,a0,720 # ffffffffc0205cb8 <default_pmm_manager+0x60>
...
ffffffffc02019fa:	36a60613          	addi	a2,a2,874 # ffffffffc0205d60 <default_pmm_manager+0x108>
ffffffffc02019fe:	06200593          	li	a1,98
ffffffffc0201a02:	00004517          	auipc	a0,0x4
ffffffffc0201a06:	2b650513          	addi	a0,a0,694 # ffffffffc0205cb8 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0201a16:	36e60613          	addi	a2,a2,878 # ffffffffc0205d80 <default_pmm_manager+0x128>
ffffffffc0201a1a:	07400593          	li	a1,116
ffffffffc0201a1e:	00004517          	auipc	a0,0x4
ffffffffc0201a22:	29a50513          	addi	a0,a0,666 # ffffffffc0205cb8 <default_pmm_manager+0x60>
pte2page(pte_t pte) {
...
ffffffffc0201bbe:	2fc030ef          	jal	ra,ffffffffc0204eba <memset>
    return page - pages + nbase;
...
ffffffffc0201c50:	26a030ef          	jal	ra,ffffffffc0204eba <memset>
    return page - pages + nbase;
...
ffffffffc0201caa:	fea60613          	addi	a2,a2,-22 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0201cae:	0e400593          	li	a1,228
ffffffffc0201cb2:	00004517          	auipc	a0,0x4
ffffffffc0201cb6:	0f650513          	addi	a0,a0,246 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0201cba:	f8cfe0ef          	jal	ra,ffffffffc0200446 <__panic>
    return &((pte_t *)KADDR(PDE_ADDR(*pdep0)))[PTX(la)];
ffffffffc0201cbe:	00004617          	auipc	a2,0x4
ffffffffc0201cc2:	fd260613          	addi	a2,a2,-46 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0201cc6:	0ef00593          	li	a1,239
ffffffffc0201cca:	00004517          	auipc	a0,0x4
ffffffffc0201cce:	0de50513          	addi	a0,a0,222 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc0201cdc:	fb860613          	addi	a2,a2,-72 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0201ce0:	0ec00593          	li	a1,236
ffffffffc0201ce4:	00004517          	auipc	a0,0x4
ffffffffc0201ce8:	0c450513          	addi	a0,a0,196 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc0201cf6:	f9e60613          	addi	a2,a2,-98 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0201cfa:	0e100593          	li	a1,225
ffffffffc0201cfe:	00004517          	auipc	a0,0x4
ffffffffc0201d02:	0aa50513          	addi	a0,a0,170 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc0201ef4:	d6878793          	addi	a5,a5,-664 # ffffffffc0205c58 <default_pmm_manager>
...
ffffffffc0201f02:	eba50513          	addi	a0,a0,-326 # ffffffffc0205db8 <default_pmm_manager+0x160>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f50:	e8450513          	addi	a0,a0,-380 # ffffffffc0205dd0 <default_pmm_manager+0x178>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f70:	e7c50513          	addi	a0,a0,-388 # ffffffffc0205de8 <default_pmm_manager+0x190>
...
ffffffffc0201fd8:	e3c50513          	addi	a0,a0,-452 # ffffffffc0205e10 <default_pmm_manager+0x1b8>
...
ffffffffc0201ff4:	e3850513          	addi	a0,a0,-456 # ffffffffc0205e28 <default_pmm_manager+0x1d0>
...
ffffffffc0202294:	e8050513          	addi	a0,a0,-384 # ffffffffc0206110 <default_pmm_manager+0x4b8>
...
ffffffffc020234a:	f0258593          	addi	a1,a1,-254 # ffffffffc0206248 <default_pmm_manager+0x5f0>
ffffffffc020234e:	10000513          	li	a0,256
ffffffffc0202352:	323020ef          	jal	ra,ffffffffc0204e74 <strcpy>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202356:	10040593          	addi	a1,s0,256
ffffffffc020235a:	10000513          	li	a0,256
ffffffffc020235e:	329020ef          	jal	ra,ffffffffc0204e86 <strcmp>
...
ffffffffc0202390:	10068023          	sb	zero,256(a3)
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202394:	2ab020ef          	jal	ra,ffffffffc0204e3e <strlen>
...
ffffffffc0202458:	e6c50513          	addi	a0,a0,-404 # ffffffffc02062c0 <default_pmm_manager+0x668>
...
ffffffffc0202572:	c0268693          	addi	a3,a3,-1022 # ffffffffc0206170 <default_pmm_manager+0x518>
ffffffffc0202576:	00003617          	auipc	a2,0x3
ffffffffc020257a:	33260613          	addi	a2,a2,818 # ffffffffc02058a8 <commands+0x738>
ffffffffc020257e:	19e00593          	li	a1,414
ffffffffc0202582:	00004517          	auipc	a0,0x4
ffffffffc0202586:	82650513          	addi	a0,a0,-2010 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020258a:	ebdfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc020258e:	00004697          	auipc	a3,0x4
ffffffffc0202592:	ba268693          	addi	a3,a3,-1118 # ffffffffc0206130 <default_pmm_manager+0x4d8>
ffffffffc0202596:	00003617          	auipc	a2,0x3
ffffffffc020259a:	31260613          	addi	a2,a2,786 # ffffffffc02058a8 <commands+0x738>
ffffffffc020259e:	19d00593          	li	a1,413
ffffffffc02025a2:	00004517          	auipc	a0,0x4
ffffffffc02025a6:	80650513          	addi	a0,a0,-2042 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc02025b4:	6e060613          	addi	a2,a2,1760 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc02025b8:	19d00593          	li	a1,413
ffffffffc02025bc:	00003517          	auipc	a0,0x3
ffffffffc02025c0:	7ec50513          	addi	a0,a0,2028 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc02025d0:	76c60613          	addi	a2,a2,1900 # ffffffffc0205d38 <default_pmm_manager+0xe0>
ffffffffc02025d4:	07f00593          	li	a1,127
ffffffffc02025d8:	00003517          	auipc	a0,0x3
ffffffffc02025dc:	7d050513          	addi	a0,a0,2000 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02025e0:	e67fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025e4:	00003617          	auipc	a2,0x3
ffffffffc02025e8:	75460613          	addi	a2,a2,1876 # ffffffffc0205d38 <default_pmm_manager+0xe0>
ffffffffc02025ec:	0c300593          	li	a1,195
ffffffffc02025f0:	00003517          	auipc	a0,0x3
ffffffffc02025f4:	7b850513          	addi	a0,a0,1976 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02025f8:	e4ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025fc:	00004697          	auipc	a3,0x4
ffffffffc0202600:	86c68693          	addi	a3,a3,-1940 # ffffffffc0205e68 <default_pmm_manager+0x210>
ffffffffc0202604:	00003617          	auipc	a2,0x3
ffffffffc0202608:	2a460613          	addi	a2,a2,676 # ffffffffc02058a8 <commands+0x738>
ffffffffc020260c:	16100593          	li	a1,353
ffffffffc0202610:	00003517          	auipc	a0,0x3
ffffffffc0202614:	79850513          	addi	a0,a0,1944 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202618:	e2ffd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc020261c:	00004697          	auipc	a3,0x4
ffffffffc0202620:	82c68693          	addi	a3,a3,-2004 # ffffffffc0205e48 <default_pmm_manager+0x1f0>
ffffffffc0202624:	00003617          	auipc	a2,0x3
ffffffffc0202628:	28460613          	addi	a2,a2,644 # ffffffffc02058a8 <commands+0x738>
ffffffffc020262c:	16000593          	li	a1,352
ffffffffc0202630:	00003517          	auipc	a0,0x3
ffffffffc0202634:	77850513          	addi	a0,a0,1912 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc0202644:	8b868693          	addi	a3,a3,-1864 # ffffffffc0205ef8 <default_pmm_manager+0x2a0>
ffffffffc0202648:	00003617          	auipc	a2,0x3
ffffffffc020264c:	26060613          	addi	a2,a2,608 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202650:	16900593          	li	a1,361
ffffffffc0202654:	00003517          	auipc	a0,0x3
ffffffffc0202658:	75450513          	addi	a0,a0,1876 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020265c:	debfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202660:	00004697          	auipc	a3,0x4
ffffffffc0202664:	86868693          	addi	a3,a3,-1944 # ffffffffc0205ec8 <default_pmm_manager+0x270>
ffffffffc0202668:	00003617          	auipc	a2,0x3
ffffffffc020266c:	24060613          	addi	a2,a2,576 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202670:	16600593          	li	a1,358
ffffffffc0202674:	00003517          	auipc	a0,0x3
ffffffffc0202678:	73450513          	addi	a0,a0,1844 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020267c:	dcbfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202680:	00004697          	auipc	a3,0x4
ffffffffc0202684:	82068693          	addi	a3,a3,-2016 # ffffffffc0205ea0 <default_pmm_manager+0x248>
ffffffffc0202688:	00003617          	auipc	a2,0x3
ffffffffc020268c:	22060613          	addi	a2,a2,544 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202690:	16200593          	li	a1,354
ffffffffc0202694:	00003517          	auipc	a0,0x3
ffffffffc0202698:	71450513          	addi	a0,a0,1812 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020269c:	dabfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc02026a0:	00004697          	auipc	a3,0x4
ffffffffc02026a4:	8e068693          	addi	a3,a3,-1824 # ffffffffc0205f80 <default_pmm_manager+0x328>
ffffffffc02026a8:	00003617          	auipc	a2,0x3
ffffffffc02026ac:	20060613          	addi	a2,a2,512 # ffffffffc02058a8 <commands+0x738>
ffffffffc02026b0:	17200593          	li	a1,370
ffffffffc02026b4:	00003517          	auipc	a0,0x3
ffffffffc02026b8:	6f450513          	addi	a0,a0,1780 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02026bc:	d8bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc02026c0:	00004697          	auipc	a3,0x4
ffffffffc02026c4:	96068693          	addi	a3,a3,-1696 # ffffffffc0206020 <default_pmm_manager+0x3c8>
ffffffffc02026c8:	00003617          	auipc	a2,0x3
ffffffffc02026cc:	1e060613          	addi	a2,a2,480 # ffffffffc02058a8 <commands+0x738>
ffffffffc02026d0:	17700593          	li	a1,375
ffffffffc02026d4:	00003517          	auipc	a0,0x3
ffffffffc02026d8:	6d450513          	addi	a0,a0,1748 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02026dc:	d6bfd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026e0:	00004697          	auipc	a3,0x4
ffffffffc02026e4:	87868693          	addi	a3,a3,-1928 # ffffffffc0205f58 <default_pmm_manager+0x300>
ffffffffc02026e8:	00003617          	auipc	a2,0x3
ffffffffc02026ec:	1c060613          	addi	a2,a2,448 # ffffffffc02058a8 <commands+0x738>
ffffffffc02026f0:	16f00593          	li	a1,367
ffffffffc02026f4:	00003517          	auipc	a0,0x3
ffffffffc02026f8:	6b450513          	addi	a0,a0,1716 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc0202706:	58e60613          	addi	a2,a2,1422 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc020270a:	16e00593          	li	a1,366
ffffffffc020270e:	00003517          	auipc	a0,0x3
ffffffffc0202712:	69a50513          	addi	a0,a0,1690 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202716:	d31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc020271a:	00004697          	auipc	a3,0x4
ffffffffc020271e:	89e68693          	addi	a3,a3,-1890 # ffffffffc0205fb8 <default_pmm_manager+0x360>
ffffffffc0202722:	00003617          	auipc	a2,0x3
ffffffffc0202726:	18660613          	addi	a2,a2,390 # ffffffffc02058a8 <commands+0x738>
ffffffffc020272a:	17c00593          	li	a1,380
ffffffffc020272e:	00003517          	auipc	a0,0x3
ffffffffc0202732:	67a50513          	addi	a0,a0,1658 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202736:	d11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc020273a:	00004697          	auipc	a3,0x4
ffffffffc020273e:	94668693          	addi	a3,a3,-1722 # ffffffffc0206080 <default_pmm_manager+0x428>
ffffffffc0202742:	00003617          	auipc	a2,0x3
ffffffffc0202746:	16660613          	addi	a2,a2,358 # ffffffffc02058a8 <commands+0x738>
ffffffffc020274a:	17b00593          	li	a1,379
ffffffffc020274e:	00003517          	auipc	a0,0x3
ffffffffc0202752:	65a50513          	addi	a0,a0,1626 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202756:	cf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc020275a:	00004697          	auipc	a3,0x4
ffffffffc020275e:	90e68693          	addi	a3,a3,-1778 # ffffffffc0206068 <default_pmm_manager+0x410>
ffffffffc0202762:	00003617          	auipc	a2,0x3
ffffffffc0202766:	14660613          	addi	a2,a2,326 # ffffffffc02058a8 <commands+0x738>
ffffffffc020276a:	17a00593          	li	a1,378
ffffffffc020276e:	00003517          	auipc	a0,0x3
ffffffffc0202772:	63a50513          	addi	a0,a0,1594 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202776:	cd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc020277a:	00004697          	auipc	a3,0x4
ffffffffc020277e:	8be68693          	addi	a3,a3,-1858 # ffffffffc0206038 <default_pmm_manager+0x3e0>
ffffffffc0202782:	00003617          	auipc	a2,0x3
ffffffffc0202786:	12660613          	addi	a2,a2,294 # ffffffffc02058a8 <commands+0x738>
ffffffffc020278a:	17900593          	li	a1,377
ffffffffc020278e:	00003517          	auipc	a0,0x3
ffffffffc0202792:	61a50513          	addi	a0,a0,1562 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202796:	cb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc020279a:	00004697          	auipc	a3,0x4
ffffffffc020279e:	a5668693          	addi	a3,a3,-1450 # ffffffffc02061f0 <default_pmm_manager+0x598>
ffffffffc02027a2:	00003617          	auipc	a2,0x3
ffffffffc02027a6:	10660613          	addi	a2,a2,262 # ffffffffc02058a8 <commands+0x738>
ffffffffc02027aa:	1a700593          	li	a1,423
ffffffffc02027ae:	00003517          	auipc	a0,0x3
ffffffffc02027b2:	5fa50513          	addi	a0,a0,1530 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02027b6:	c91fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc02027ba:	00004697          	auipc	a3,0x4
ffffffffc02027be:	84e68693          	addi	a3,a3,-1970 # ffffffffc0206008 <default_pmm_manager+0x3b0>
ffffffffc02027c2:	00003617          	auipc	a2,0x3
ffffffffc02027c6:	0e660613          	addi	a2,a2,230 # ffffffffc02058a8 <commands+0x738>
ffffffffc02027ca:	17600593          	li	a1,374
ffffffffc02027ce:	00003517          	auipc	a0,0x3
ffffffffc02027d2:	5da50513          	addi	a0,a0,1498 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02027d6:	c71fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027da:	00004697          	auipc	a3,0x4
ffffffffc02027de:	81e68693          	addi	a3,a3,-2018 # ffffffffc0205ff8 <default_pmm_manager+0x3a0>
ffffffffc02027e2:	00003617          	auipc	a2,0x3
ffffffffc02027e6:	0c660613          	addi	a2,a2,198 # ffffffffc02058a8 <commands+0x738>
ffffffffc02027ea:	17500593          	li	a1,373
ffffffffc02027ee:	00003517          	auipc	a0,0x3
ffffffffc02027f2:	5ba50513          	addi	a0,a0,1466 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02027f6:	c51fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027fa:	00004697          	auipc	a3,0x4
ffffffffc02027fe:	8f668693          	addi	a3,a3,-1802 # ffffffffc02060f0 <default_pmm_manager+0x498>
ffffffffc0202802:	00003617          	auipc	a2,0x3
ffffffffc0202806:	0a660613          	addi	a2,a2,166 # ffffffffc02058a8 <commands+0x738>
ffffffffc020280a:	1b800593          	li	a1,440
ffffffffc020280e:	00003517          	auipc	a0,0x3
ffffffffc0202812:	59a50513          	addi	a0,a0,1434 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202816:	c31fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*ptep & PTE_U);
ffffffffc020281a:	00003697          	auipc	a3,0x3
ffffffffc020281e:	7ce68693          	addi	a3,a3,1998 # ffffffffc0205fe8 <default_pmm_manager+0x390>
ffffffffc0202822:	00003617          	auipc	a2,0x3
ffffffffc0202826:	08660613          	addi	a2,a2,134 # ffffffffc02058a8 <commands+0x738>
ffffffffc020282a:	17400593          	li	a1,372
ffffffffc020282e:	00003517          	auipc	a0,0x3
ffffffffc0202832:	57a50513          	addi	a0,a0,1402 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202836:	c11fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc020283a:	00003697          	auipc	a3,0x3
ffffffffc020283e:	70668693          	addi	a3,a3,1798 # ffffffffc0205f40 <default_pmm_manager+0x2e8>
ffffffffc0202842:	00003617          	auipc	a2,0x3
ffffffffc0202846:	06660613          	addi	a2,a2,102 # ffffffffc02058a8 <commands+0x738>
ffffffffc020284a:	18100593          	li	a1,385
ffffffffc020284e:	00003517          	auipc	a0,0x3
ffffffffc0202852:	55a50513          	addi	a0,a0,1370 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202856:	bf1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc020285a:	00004697          	auipc	a3,0x4
ffffffffc020285e:	83e68693          	addi	a3,a3,-1986 # ffffffffc0206098 <default_pmm_manager+0x440>
ffffffffc0202862:	00003617          	auipc	a2,0x3
ffffffffc0202866:	04660613          	addi	a2,a2,70 # ffffffffc02058a8 <commands+0x738>
ffffffffc020286a:	17e00593          	li	a1,382
ffffffffc020286e:	00003517          	auipc	a0,0x3
ffffffffc0202872:	53a50513          	addi	a0,a0,1338 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202876:	bd1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020287a:	00003697          	auipc	a3,0x3
ffffffffc020287e:	6ae68693          	addi	a3,a3,1710 # ffffffffc0205f28 <default_pmm_manager+0x2d0>
ffffffffc0202882:	00003617          	auipc	a2,0x3
ffffffffc0202886:	02660613          	addi	a2,a2,38 # ffffffffc02058a8 <commands+0x738>
ffffffffc020288a:	17d00593          	li	a1,381
ffffffffc020288e:	00003517          	auipc	a0,0x3
ffffffffc0202892:	51a50513          	addi	a0,a0,1306 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202896:	bb1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc020289a:	00003617          	auipc	a2,0x3
ffffffffc020289e:	3f660613          	addi	a2,a2,1014 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc02028a2:	06900593          	li	a1,105
ffffffffc02028a6:	00003517          	auipc	a0,0x3
ffffffffc02028aa:	41250513          	addi	a0,a0,1042 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc02028ae:	b99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc02028b2:	00004697          	auipc	a3,0x4
ffffffffc02028b6:	81668693          	addi	a3,a3,-2026 # ffffffffc02060c8 <default_pmm_manager+0x470>
ffffffffc02028ba:	00003617          	auipc	a2,0x3
ffffffffc02028be:	fee60613          	addi	a2,a2,-18 # ffffffffc02058a8 <commands+0x738>
ffffffffc02028c2:	18800593          	li	a1,392
ffffffffc02028c6:	00003517          	auipc	a0,0x3
ffffffffc02028ca:	4e250513          	addi	a0,a0,1250 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02028ce:	b79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028d2:	00003697          	auipc	a3,0x3
ffffffffc02028d6:	7ae68693          	addi	a3,a3,1966 # ffffffffc0206080 <default_pmm_manager+0x428>
ffffffffc02028da:	00003617          	auipc	a2,0x3
ffffffffc02028de:	fce60613          	addi	a2,a2,-50 # ffffffffc02058a8 <commands+0x738>
ffffffffc02028e2:	18600593          	li	a1,390
ffffffffc02028e6:	00003517          	auipc	a0,0x3
ffffffffc02028ea:	4c250513          	addi	a0,a0,1218 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02028ee:	b59fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028f2:	00003697          	auipc	a3,0x3
ffffffffc02028f6:	7be68693          	addi	a3,a3,1982 # ffffffffc02060b0 <default_pmm_manager+0x458>
ffffffffc02028fa:	00003617          	auipc	a2,0x3
ffffffffc02028fe:	fae60613          	addi	a2,a2,-82 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202902:	18500593          	li	a1,389
ffffffffc0202906:	00003517          	auipc	a0,0x3
ffffffffc020290a:	4a250513          	addi	a0,a0,1186 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020290e:	b39fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202912:	00003697          	auipc	a3,0x3
ffffffffc0202916:	76e68693          	addi	a3,a3,1902 # ffffffffc0206080 <default_pmm_manager+0x428>
ffffffffc020291a:	00003617          	auipc	a2,0x3
ffffffffc020291e:	f8e60613          	addi	a2,a2,-114 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202922:	18200593          	li	a1,386
ffffffffc0202926:	00003517          	auipc	a0,0x3
ffffffffc020292a:	48250513          	addi	a0,a0,1154 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020292e:	b19fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 1);
ffffffffc0202932:	00004697          	auipc	a3,0x4
ffffffffc0202936:	8a668693          	addi	a3,a3,-1882 # ffffffffc02061d8 <default_pmm_manager+0x580>
ffffffffc020293a:	00003617          	auipc	a2,0x3
ffffffffc020293e:	f6e60613          	addi	a2,a2,-146 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202942:	1a600593          	li	a1,422
ffffffffc0202946:	00003517          	auipc	a0,0x3
ffffffffc020294a:	46250513          	addi	a0,a0,1122 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020294e:	af9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc0202952:	00004697          	auipc	a3,0x4
ffffffffc0202956:	84e68693          	addi	a3,a3,-1970 # ffffffffc02061a0 <default_pmm_manager+0x548>
ffffffffc020295a:	00003617          	auipc	a2,0x3
ffffffffc020295e:	f4e60613          	addi	a2,a2,-178 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202962:	1a500593          	li	a1,421
ffffffffc0202966:	00003517          	auipc	a0,0x3
ffffffffc020296a:	44250513          	addi	a0,a0,1090 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020296e:	ad9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc0202972:	00004697          	auipc	a3,0x4
ffffffffc0202976:	81668693          	addi	a3,a3,-2026 # ffffffffc0206188 <default_pmm_manager+0x530>
ffffffffc020297a:	00003617          	auipc	a2,0x3
ffffffffc020297e:	f2e60613          	addi	a2,a2,-210 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202982:	1a100593          	li	a1,417
ffffffffc0202986:	00003517          	auipc	a0,0x3
ffffffffc020298a:	42250513          	addi	a0,a0,1058 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc020298e:	ab9fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc0202992:	00003697          	auipc	a3,0x3
ffffffffc0202996:	75e68693          	addi	a3,a3,1886 # ffffffffc02060f0 <default_pmm_manager+0x498>
ffffffffc020299a:	00003617          	auipc	a2,0x3
ffffffffc020299e:	f0e60613          	addi	a2,a2,-242 # ffffffffc02058a8 <commands+0x738>
ffffffffc02029a2:	19000593          	li	a1,400
ffffffffc02029a6:	00003517          	auipc	a0,0x3
ffffffffc02029aa:	40250513          	addi	a0,a0,1026 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02029ae:	a99fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc02029b2:	00003697          	auipc	a3,0x3
ffffffffc02029b6:	57668693          	addi	a3,a3,1398 # ffffffffc0205f28 <default_pmm_manager+0x2d0>
ffffffffc02029ba:	00003617          	auipc	a2,0x3
ffffffffc02029be:	eee60613          	addi	a2,a2,-274 # ffffffffc02058a8 <commands+0x738>
ffffffffc02029c2:	16a00593          	li	a1,362
ffffffffc02029c6:	00003517          	auipc	a0,0x3
ffffffffc02029ca:	3e250513          	addi	a0,a0,994 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02029ce:	a79fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029d2:	00003617          	auipc	a2,0x3
ffffffffc02029d6:	2be60613          	addi	a2,a2,702 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc02029da:	16d00593          	li	a1,365
ffffffffc02029de:	00003517          	auipc	a0,0x3
ffffffffc02029e2:	3ca50513          	addi	a0,a0,970 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc02029e6:	a61fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029ea:	00003697          	auipc	a3,0x3
ffffffffc02029ee:	55668693          	addi	a3,a3,1366 # ffffffffc0205f40 <default_pmm_manager+0x2e8>
ffffffffc02029f2:	00003617          	auipc	a2,0x3
ffffffffc02029f6:	eb660613          	addi	a2,a2,-330 # ffffffffc02058a8 <commands+0x738>
ffffffffc02029fa:	16b00593          	li	a1,363
ffffffffc02029fe:	00003517          	auipc	a0,0x3
ffffffffc0202a02:	3aa50513          	addi	a0,a0,938 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202a06:	a41fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc0202a0a:	00003697          	auipc	a3,0x3
ffffffffc0202a0e:	5ae68693          	addi	a3,a3,1454 # ffffffffc0205fb8 <default_pmm_manager+0x360>
ffffffffc0202a12:	00003617          	auipc	a2,0x3
ffffffffc0202a16:	e9660613          	addi	a2,a2,-362 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202a1a:	17300593          	li	a1,371
ffffffffc0202a1e:	00003517          	auipc	a0,0x3
ffffffffc0202a22:	38a50513          	addi	a0,a0,906 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202a26:	a21fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a2a:	00004697          	auipc	a3,0x4
ffffffffc0202a2e:	86e68693          	addi	a3,a3,-1938 # ffffffffc0206298 <default_pmm_manager+0x640>
ffffffffc0202a32:	00003617          	auipc	a2,0x3
ffffffffc0202a36:	e7660613          	addi	a2,a2,-394 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202a3a:	1af00593          	li	a1,431
ffffffffc0202a3e:	00003517          	auipc	a0,0x3
ffffffffc0202a42:	36a50513          	addi	a0,a0,874 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202a46:	a01fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a4a:	00004697          	auipc	a3,0x4
ffffffffc0202a4e:	81668693          	addi	a3,a3,-2026 # ffffffffc0206260 <default_pmm_manager+0x608>
ffffffffc0202a52:	00003617          	auipc	a2,0x3
ffffffffc0202a56:	e5660613          	addi	a2,a2,-426 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202a5a:	1ac00593          	li	a1,428
ffffffffc0202a5e:	00003517          	auipc	a0,0x3
ffffffffc0202a62:	34a50513          	addi	a0,a0,842 # ffffffffc0205da8 <default_pmm_manager+0x150>
ffffffffc0202a66:	9e1fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a6a:	00003697          	auipc	a3,0x3
ffffffffc0202a6e:	7c668693          	addi	a3,a3,1990 # ffffffffc0206230 <default_pmm_manager+0x5d8>
ffffffffc0202a72:	00003617          	auipc	a2,0x3
ffffffffc0202a76:	e3660613          	addi	a2,a2,-458 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202a7a:	1a800593          	li	a1,424
ffffffffc0202a7e:	00003517          	auipc	a0,0x3
ffffffffc0202a82:	32a50513          	addi	a0,a0,810 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc0202af4:	7f068693          	addi	a3,a3,2032 # ffffffffc02062e0 <default_pmm_manager+0x688>
ffffffffc0202af8:	00003617          	auipc	a2,0x3
ffffffffc0202afc:	db060613          	addi	a2,a2,-592 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202b00:	14800593          	li	a1,328
ffffffffc0202b04:	00003517          	auipc	a0,0x3
ffffffffc0202b08:	2a450513          	addi	a0,a0,676 # ffffffffc0205da8 <default_pmm_manager+0x150>
...
ffffffffc0202b4e:	21660613          	addi	a2,a2,534 # ffffffffc0205d60 <default_pmm_manager+0x108>
ffffffffc0202b52:	06200593          	li	a1,98
ffffffffc0202b56:	00003517          	auipc	a0,0x3
ffffffffc0202b5a:	16250513          	addi	a0,a0,354 # ffffffffc0205cb8 <default_pmm_manager+0x60>
pa2page(uintptr_t pa) {
...
ffffffffc0202bde:	74e50513          	addi	a0,a0,1870 # ffffffffc0206328 <default_pmm_manager+0x6d0>
    return listelm->next;
...
ffffffffc0202c30:	71450513          	addi	a0,a0,1812 # ffffffffc0206340 <default_pmm_manager+0x6e8>
...
ffffffffc0202c84:	73050513          	addi	a0,a0,1840 # ffffffffc02063b0 <default_pmm_manager+0x758>
...
ffffffffc0202ca0:	76450513          	addi	a0,a0,1892 # ffffffffc0206400 <default_pmm_manager+0x7a8>
...
ffffffffc0202d14:	77850513          	addi	a0,a0,1912 # ffffffffc0206488 <default_pmm_manager+0x830>
...
ffffffffc0202e2c:	1c060613          	addi	a2,a2,448 # ffffffffc0206fe8 <nbase>
...
ffffffffc0202e58:	6dc50513          	addi	a0,a0,1756 # ffffffffc0206530 <default_pmm_manager+0x8d8>
...
ffffffffc0202f2c:	65850513          	addi	a0,a0,1624 # ffffffffc0206580 <default_pmm_manager+0x928>
...
ffffffffc0202f3e:	95e68693          	addi	a3,a3,-1698 # ffffffffc0205898 <commands+0x728>
ffffffffc0202f42:	00003617          	auipc	a2,0x3
ffffffffc0202f46:	96660613          	addi	a2,a2,-1690 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202f4a:	0bd00593          	li	a1,189
ffffffffc0202f4e:	00003517          	auipc	a0,0x3
ffffffffc0202f52:	3ca50513          	addi	a0,a0,970 # ffffffffc0206318 <default_pmm_manager+0x6c0>
...
ffffffffc0202f62:	e0260613          	addi	a2,a2,-510 # ffffffffc0205d60 <default_pmm_manager+0x108>
ffffffffc0202f66:	06200593          	li	a1,98
ffffffffc0202f6a:	00003517          	auipc	a0,0x3
ffffffffc0202f6e:	d4e50513          	addi	a0,a0,-690 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc0202f72:	cd4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f76:	00003697          	auipc	a3,0x3
ffffffffc0202f7a:	59268693          	addi	a3,a3,1426 # ffffffffc0206508 <default_pmm_manager+0x8b0>
ffffffffc0202f7e:	00003617          	auipc	a2,0x3
ffffffffc0202f82:	92a60613          	addi	a2,a2,-1750 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202f86:	0fd00593          	li	a1,253
ffffffffc0202f8a:	00003517          	auipc	a0,0x3
ffffffffc0202f8e:	38e50513          	addi	a0,a0,910 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0202f92:	cb4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f96:	00003697          	auipc	a3,0x3
ffffffffc0202f9a:	49268693          	addi	a3,a3,1170 # ffffffffc0206428 <default_pmm_manager+0x7d0>
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	90a60613          	addi	a2,a2,-1782 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202fa6:	0dd00593          	li	a1,221
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	36e50513          	addi	a0,a0,878 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0202fb2:	c94fd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202fb6:	00003617          	auipc	a2,0x3
ffffffffc0202fba:	34260613          	addi	a2,a2,834 # ffffffffc02062f8 <default_pmm_manager+0x6a0>
ffffffffc0202fbe:	02a00593          	li	a1,42
ffffffffc0202fc2:	00003517          	auipc	a0,0x3
ffffffffc0202fc6:	35650513          	addi	a0,a0,854 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0202fca:	c7cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
         assert(check_ptep[i] != NULL);
ffffffffc0202fce:	00003697          	auipc	a3,0x3
ffffffffc0202fd2:	52268693          	addi	a3,a3,1314 # ffffffffc02064f0 <default_pmm_manager+0x898>
ffffffffc0202fd6:	00003617          	auipc	a2,0x3
ffffffffc0202fda:	8d260613          	addi	a2,a2,-1838 # ffffffffc02058a8 <commands+0x738>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	33650513          	addi	a0,a0,822 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0202fea:	c5cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	d9260613          	addi	a2,a2,-622 # ffffffffc0205d80 <default_pmm_manager+0x128>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	cbe50513          	addi	a0,a0,-834 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc0203002:	c44fd0ef          	jal	ra,ffffffffc0200446 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	43a68693          	addi	a3,a3,1082 # ffffffffc0206440 <default_pmm_manager+0x7e8>
ffffffffc020300e:	00003617          	auipc	a2,0x3
ffffffffc0203012:	89a60613          	addi	a2,a2,-1894 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	2fe50513          	addi	a0,a0,766 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0203022:	c24fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	35268693          	addi	a3,a3,850 # ffffffffc0206378 <default_pmm_manager+0x720>
ffffffffc020302e:	00003617          	auipc	a2,0x3
ffffffffc0203032:	87a60613          	addi	a2,a2,-1926 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	2de50513          	addi	a0,a0,734 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0203042:	c04fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00003697          	auipc	a3,0x3
ffffffffc020304a:	89268693          	addi	a3,a3,-1902 # ffffffffc02058d8 <commands+0x768>
ffffffffc020304e:	00003617          	auipc	a2,0x3
ffffffffc0203052:	85a60613          	addi	a2,a2,-1958 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	2be50513          	addi	a0,a0,702 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0203062:	be4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	a1a68693          	addi	a3,a3,-1510 # ffffffffc0205a80 <commands+0x910>
ffffffffc020306e:	00003617          	auipc	a2,0x3
ffffffffc0203072:	83a60613          	addi	a2,a2,-1990 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	29e50513          	addi	a0,a0,670 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc0203082:	bc4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	30a68693          	addi	a3,a3,778 # ffffffffc0206390 <default_pmm_manager+0x738>
ffffffffc020308e:	00003617          	auipc	a2,0x3
ffffffffc0203092:	81a60613          	addi	a2,a2,-2022 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	27e50513          	addi	a0,a0,638 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc02030a2:	ba4fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	2c268693          	addi	a3,a3,706 # ffffffffc0206368 <default_pmm_manager+0x710>
ffffffffc02030ae:	00002617          	auipc	a2,0x2
ffffffffc02030b2:	7fa60613          	addi	a2,a2,2042 # ffffffffc02058a8 <commands+0x738>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	25e50513          	addi	a0,a0,606 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc02030c2:	b84fd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	4aa68693          	addi	a3,a3,1194 # ffffffffc0206570 <default_pmm_manager+0x918>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	7da60613          	addi	a2,a2,2010 # ffffffffc02058a8 <commands+0x738>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	23e50513          	addi	a0,a0,574 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc02030e2:	b64fd0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	baa60613          	addi	a2,a2,-1110 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	bc650513          	addi	a0,a0,-1082 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc02030fa:	b4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	46268693          	addi	a3,a3,1122 # ffffffffc0206560 <default_pmm_manager+0x908>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	7a260613          	addi	a2,a2,1954 # ffffffffc02058a8 <commands+0x738>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	20650513          	addi	a0,a0,518 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020311a:	b2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	39268693          	addi	a3,a3,914 # ffffffffc02064b0 <default_pmm_manager+0x858>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	78260613          	addi	a2,a2,1922 # ffffffffc02058a8 <commands+0x738>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	1e650513          	addi	a0,a0,486 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020313a:	b0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	32268693          	addi	a3,a3,802 # ffffffffc0206460 <default_pmm_manager+0x808>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	76260613          	addi	a2,a2,1890 # ffffffffc02058a8 <commands+0x738>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	1c650513          	addi	a0,a0,454 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020315a:	aecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	28a68693          	addi	a3,a3,650 # ffffffffc02063e8 <default_pmm_manager+0x790>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	74260613          	addi	a2,a2,1858 # ffffffffc02058a8 <commands+0x738>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	1a650513          	addi	a0,a0,422 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020317a:	accfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	3da68693          	addi	a3,a3,986 # ffffffffc0206558 <default_pmm_manager+0x900>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	72260613          	addi	a2,a2,1826 # ffffffffc02058a8 <commands+0x738>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	18650513          	addi	a0,a0,390 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020319a:	aacfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	20268693          	addi	a3,a3,514 # ffffffffc02063a0 <default_pmm_manager+0x748>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	70260613          	addi	a2,a2,1794 # ffffffffc02058a8 <commands+0x738>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	16650513          	addi	a0,a0,358 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc02031ba:	a8cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	32268693          	addi	a3,a3,802 # ffffffffc02064e0 <default_pmm_manager+0x888>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	6e260613          	addi	a2,a2,1762 # ffffffffc02058a8 <commands+0x738>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	14650513          	addi	a0,a0,326 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc02031da:	a6cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	30268693          	addi	a3,a3,770 # ffffffffc02064e0 <default_pmm_manager+0x888>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	6c260613          	addi	a2,a2,1730 # ffffffffc02058a8 <commands+0x738>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	12650513          	addi	a0,a0,294 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc02031fa:	a4cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	2c268693          	addi	a3,a3,706 # ffffffffc02064c0 <default_pmm_manager+0x868>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	6a260613          	addi	a2,a2,1698 # ffffffffc02058a8 <commands+0x738>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	10650513          	addi	a0,a0,262 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020321a:	a2cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	2a268693          	addi	a3,a3,674 # ffffffffc02064c0 <default_pmm_manager+0x868>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	68260613          	addi	a2,a2,1666 # ffffffffc02058a8 <commands+0x738>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	0e650513          	addi	a0,a0,230 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020323a:	a0cfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	29268693          	addi	a3,a3,658 # ffffffffc02064d0 <default_pmm_manager+0x878>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	66260613          	addi	a2,a2,1634 # ffffffffc02058a8 <commands+0x738>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	0c650513          	addi	a0,a0,198 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020325a:	9ecfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	27268693          	addi	a3,a3,626 # ffffffffc02064d0 <default_pmm_manager+0x878>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	64260613          	addi	a2,a2,1602 # ffffffffc02058a8 <commands+0x738>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	0a650513          	addi	a0,a0,166 # ffffffffc0206318 <default_pmm_manager+0x6c0>
ffffffffc020327a:	9ccfd0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	23268693          	addi	a3,a3,562 # ffffffffc02064b0 <default_pmm_manager+0x858>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	62260613          	addi	a2,a2,1570 # ffffffffc02058a8 <commands+0x738>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	08650513          	addi	a0,a0,134 # ffffffffc0206318 <default_pmm_manager+0x6c0>
...
ffffffffc02032e2:	322b0b13          	addi	s6,s6,802 # ffffffffc0206600 <default_pmm_manager+0x9a8>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e6:	00003b97          	auipc	s7,0x3
ffffffffc02032ea:	302b8b93          	addi	s7,s7,770 # ffffffffc02065e8 <default_pmm_manager+0x990>
...
ffffffffc020339c:	20850513          	addi	a0,a0,520 # ffffffffc02065a0 <default_pmm_manager+0x948>
...
ffffffffc02033ae:	22668693          	addi	a3,a3,550 # ffffffffc02065d0 <default_pmm_manager+0x978>
ffffffffc02033b2:	00002617          	auipc	a2,0x2
ffffffffc02033b6:	4f660613          	addi	a2,a2,1270 # ffffffffc02058a8 <commands+0x738>
ffffffffc02033ba:	06900593          	li	a1,105
ffffffffc02033be:	00003517          	auipc	a0,0x3
ffffffffc02033c2:	f5a50513          	addi	a0,a0,-166 # ffffffffc0206318 <default_pmm_manager+0x6c0>
...
ffffffffc0203406:	24e50513          	addi	a0,a0,590 # ffffffffc0206650 <default_pmm_manager+0x9f8>
...
ffffffffc0203428:	21c68693          	addi	a3,a3,540 # ffffffffc0206640 <default_pmm_manager+0x9e8>
ffffffffc020342c:	00002617          	auipc	a2,0x2
ffffffffc0203430:	47c60613          	addi	a2,a2,1148 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203434:	07f00593          	li	a1,127
ffffffffc0203438:	00003517          	auipc	a0,0x3
ffffffffc020343c:	ee050513          	addi	a0,a0,-288 # ffffffffc0206318 <default_pmm_manager+0x6c0>
...
ffffffffc020346c:	22850513          	addi	a0,a0,552 # ffffffffc0206690 <default_pmm_manager+0xa38>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	23250513          	addi	a0,a0,562 # ffffffffc02066d0 <default_pmm_manager+0xa78>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c6:	23650513          	addi	a0,a0,566 # ffffffffc02066f8 <default_pmm_manager+0xaa0>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e4:	24050513          	addi	a0,a0,576 # ffffffffc0206720 <default_pmm_manager+0xac8>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	24c50513          	addi	a0,a0,588 # ffffffffc0206748 <default_pmm_manager+0xaf0>
...
ffffffffc020351e:	20650513          	addi	a0,a0,518 # ffffffffc0206720 <default_pmm_manager+0xac8>
...
ffffffffc0203536:	19e50513          	addi	a0,a0,414 # ffffffffc02066d0 <default_pmm_manager+0xa78>
...
ffffffffc0203550:	1d450513          	addi	a0,a0,468 # ffffffffc0206720 <default_pmm_manager+0xac8>
...
ffffffffc020356a:	12a50513          	addi	a0,a0,298 # ffffffffc0206690 <default_pmm_manager+0xa38>
...
ffffffffc0203584:	17850513          	addi	a0,a0,376 # ffffffffc02066f8 <default_pmm_manager+0xaa0>
...
ffffffffc020359e:	1ae50513          	addi	a0,a0,430 # ffffffffc0206748 <default_pmm_manager+0xaf0>
...
ffffffffc02035bc:	11850513          	addi	a0,a0,280 # ffffffffc02066d0 <default_pmm_manager+0xa78>
...
ffffffffc02035fa:	eea68693          	addi	a3,a3,-278 # ffffffffc02064e0 <default_pmm_manager+0x888>
ffffffffc02035fe:	00002617          	auipc	a2,0x2
ffffffffc0203602:	2aa60613          	addi	a2,a2,682 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203606:	05100593          	li	a1,81
ffffffffc020360a:	00003517          	auipc	a0,0x3
ffffffffc020360e:	0ae50513          	addi	a0,a0,174 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203612:	e35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==11);
ffffffffc0203616:	00003697          	auipc	a3,0x3
ffffffffc020361a:	1e268693          	addi	a3,a3,482 # ffffffffc02067f8 <default_pmm_manager+0xba0>
ffffffffc020361e:	00002617          	auipc	a2,0x2
ffffffffc0203622:	28a60613          	addi	a2,a2,650 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203626:	07300593          	li	a1,115
ffffffffc020362a:	00003517          	auipc	a0,0x3
ffffffffc020362e:	08e50513          	addi	a0,a0,142 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203632:	e15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc0203636:	00003697          	auipc	a3,0x3
ffffffffc020363a:	19a68693          	addi	a3,a3,410 # ffffffffc02067d0 <default_pmm_manager+0xb78>
ffffffffc020363e:	00002617          	auipc	a2,0x2
ffffffffc0203642:	26a60613          	addi	a2,a2,618 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203646:	07100593          	li	a1,113
ffffffffc020364a:	00003517          	auipc	a0,0x3
ffffffffc020364e:	06e50513          	addi	a0,a0,110 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203652:	df5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==10);
ffffffffc0203656:	00003697          	auipc	a3,0x3
ffffffffc020365a:	16a68693          	addi	a3,a3,362 # ffffffffc02067c0 <default_pmm_manager+0xb68>
ffffffffc020365e:	00002617          	auipc	a2,0x2
ffffffffc0203662:	24a60613          	addi	a2,a2,586 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203666:	06f00593          	li	a1,111
ffffffffc020366a:	00003517          	auipc	a0,0x3
ffffffffc020366e:	04e50513          	addi	a0,a0,78 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203672:	dd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==9);
ffffffffc0203676:	00003697          	auipc	a3,0x3
ffffffffc020367a:	13a68693          	addi	a3,a3,314 # ffffffffc02067b0 <default_pmm_manager+0xb58>
ffffffffc020367e:	00002617          	auipc	a2,0x2
ffffffffc0203682:	22a60613          	addi	a2,a2,554 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203686:	06c00593          	li	a1,108
ffffffffc020368a:	00003517          	auipc	a0,0x3
ffffffffc020368e:	02e50513          	addi	a0,a0,46 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203692:	db5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==8);
ffffffffc0203696:	00003697          	auipc	a3,0x3
ffffffffc020369a:	10a68693          	addi	a3,a3,266 # ffffffffc02067a0 <default_pmm_manager+0xb48>
ffffffffc020369e:	00002617          	auipc	a2,0x2
ffffffffc02036a2:	20a60613          	addi	a2,a2,522 # ffffffffc02058a8 <commands+0x738>
ffffffffc02036a6:	06900593          	li	a1,105
ffffffffc02036aa:	00003517          	auipc	a0,0x3
ffffffffc02036ae:	00e50513          	addi	a0,a0,14 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc02036b2:	d95fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==7);
ffffffffc02036b6:	00003697          	auipc	a3,0x3
ffffffffc02036ba:	0da68693          	addi	a3,a3,218 # ffffffffc0206790 <default_pmm_manager+0xb38>
ffffffffc02036be:	00002617          	auipc	a2,0x2
ffffffffc02036c2:	1ea60613          	addi	a2,a2,490 # ffffffffc02058a8 <commands+0x738>
ffffffffc02036c6:	06600593          	li	a1,102
ffffffffc02036ca:	00003517          	auipc	a0,0x3
ffffffffc02036ce:	fee50513          	addi	a0,a0,-18 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc02036d2:	d75fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==6);
ffffffffc02036d6:	00003697          	auipc	a3,0x3
ffffffffc02036da:	0aa68693          	addi	a3,a3,170 # ffffffffc0206780 <default_pmm_manager+0xb28>
ffffffffc02036de:	00002617          	auipc	a2,0x2
ffffffffc02036e2:	1ca60613          	addi	a2,a2,458 # ffffffffc02058a8 <commands+0x738>
ffffffffc02036e6:	06300593          	li	a1,99
ffffffffc02036ea:	00003517          	auipc	a0,0x3
ffffffffc02036ee:	fce50513          	addi	a0,a0,-50 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc02036f2:	d55fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc02036f6:	00003697          	auipc	a3,0x3
ffffffffc02036fa:	07a68693          	addi	a3,a3,122 # ffffffffc0206770 <default_pmm_manager+0xb18>
ffffffffc02036fe:	00002617          	auipc	a2,0x2
ffffffffc0203702:	1aa60613          	addi	a2,a2,426 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203706:	06000593          	li	a1,96
ffffffffc020370a:	00003517          	auipc	a0,0x3
ffffffffc020370e:	fae50513          	addi	a0,a0,-82 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203712:	d35fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==5);
ffffffffc0203716:	00003697          	auipc	a3,0x3
ffffffffc020371a:	05a68693          	addi	a3,a3,90 # ffffffffc0206770 <default_pmm_manager+0xb18>
ffffffffc020371e:	00002617          	auipc	a2,0x2
ffffffffc0203722:	18a60613          	addi	a2,a2,394 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203726:	05d00593          	li	a1,93
ffffffffc020372a:	00003517          	auipc	a0,0x3
ffffffffc020372e:	f8e50513          	addi	a0,a0,-114 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203732:	d15fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203736:	00003697          	auipc	a3,0x3
ffffffffc020373a:	daa68693          	addi	a3,a3,-598 # ffffffffc02064e0 <default_pmm_manager+0x888>
ffffffffc020373e:	00002617          	auipc	a2,0x2
ffffffffc0203742:	16a60613          	addi	a2,a2,362 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203746:	05a00593          	li	a1,90
ffffffffc020374a:	00003517          	auipc	a0,0x3
ffffffffc020374e:	f6e50513          	addi	a0,a0,-146 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203752:	cf5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203756:	00003697          	auipc	a3,0x3
ffffffffc020375a:	d8a68693          	addi	a3,a3,-630 # ffffffffc02064e0 <default_pmm_manager+0x888>
ffffffffc020375e:	00002617          	auipc	a2,0x2
ffffffffc0203762:	14a60613          	addi	a2,a2,330 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203766:	05700593          	li	a1,87
ffffffffc020376a:	00003517          	auipc	a0,0x3
ffffffffc020376e:	f4e50513          	addi	a0,a0,-178 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc0203772:	cd5fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgfault_num==4);
ffffffffc0203776:	00003697          	auipc	a3,0x3
ffffffffc020377a:	d6a68693          	addi	a3,a3,-662 # ffffffffc02064e0 <default_pmm_manager+0x888>
ffffffffc020377e:	00002617          	auipc	a2,0x2
ffffffffc0203782:	12a60613          	addi	a2,a2,298 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203786:	05400593          	li	a1,84
ffffffffc020378a:	00003517          	auipc	a0,0x3
ffffffffc020378e:	f2e50513          	addi	a0,a0,-210 # ffffffffc02066b8 <default_pmm_manager+0xa60>
...
ffffffffc02037bc:	05068693          	addi	a3,a3,80 # ffffffffc0206808 <default_pmm_manager+0xbb0>
ffffffffc02037c0:	00002617          	auipc	a2,0x2
ffffffffc02037c4:	0e860613          	addi	a2,a2,232 # ffffffffc02058a8 <commands+0x738>
ffffffffc02037c8:	04100593          	li	a1,65
ffffffffc02037cc:	00003517          	auipc	a0,0x3
ffffffffc02037d0:	eec50513          	addi	a0,a0,-276 # ffffffffc02066b8 <default_pmm_manager+0xa60>
ffffffffc02037d4:	c73fc0ef          	jal	ra,ffffffffc0200446 <__panic>
     assert(in_tick==0);
ffffffffc02037d8:	00003697          	auipc	a3,0x3
ffffffffc02037dc:	04068693          	addi	a3,a3,64 # ffffffffc0206818 <default_pmm_manager+0xbc0>
ffffffffc02037e0:	00002617          	auipc	a2,0x2
ffffffffc02037e4:	0c860613          	addi	a2,a2,200 # ffffffffc02058a8 <commands+0x738>
ffffffffc02037e8:	04200593          	li	a1,66
ffffffffc02037ec:	00003517          	auipc	a0,0x3
ffffffffc02037f0:	ecc50513          	addi	a0,a0,-308 # ffffffffc02066b8 <default_pmm_manager+0xa60>
...
ffffffffc0203814:	01868693          	addi	a3,a3,24 # ffffffffc0206828 <default_pmm_manager+0xbd0>
ffffffffc0203818:	00002617          	auipc	a2,0x2
ffffffffc020381c:	09060613          	addi	a2,a2,144 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203820:	03200593          	li	a1,50
ffffffffc0203824:	00003517          	auipc	a0,0x3
ffffffffc0203828:	e9450513          	addi	a0,a0,-364 # ffffffffc02066b8 <default_pmm_manager+0xa60>
{
...
ffffffffc0203838:	02c68693          	addi	a3,a3,44 # ffffffffc0206860 <default_pmm_manager+0xc08>
ffffffffc020383c:	00002617          	auipc	a2,0x2
ffffffffc0203840:	06c60613          	addi	a2,a2,108 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203844:	07e00593          	li	a1,126
ffffffffc0203848:	00003517          	auipc	a0,0x3
ffffffffc020384c:	03850513          	addi	a0,a0,56 # ffffffffc0206880 <default_pmm_manager+0xc28>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203980:	f1468693          	addi	a3,a3,-236 # ffffffffc0206890 <default_pmm_manager+0xc38>
ffffffffc0203984:	00002617          	auipc	a2,0x2
ffffffffc0203988:	f2460613          	addi	a2,a2,-220 # ffffffffc02058a8 <commands+0x738>
ffffffffc020398c:	08500593          	li	a1,133
ffffffffc0203990:	00003517          	auipc	a0,0x3
ffffffffc0203994:	ef050513          	addi	a0,a0,-272 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203998:	aaffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc020399c:	00003697          	auipc	a3,0x3
ffffffffc02039a0:	f3468693          	addi	a3,a3,-204 # ffffffffc02068d0 <default_pmm_manager+0xc78>
ffffffffc02039a4:	00002617          	auipc	a2,0x2
ffffffffc02039a8:	f0460613          	addi	a2,a2,-252 # ffffffffc02058a8 <commands+0x738>
ffffffffc02039ac:	07d00593          	li	a1,125
ffffffffc02039b0:	00003517          	auipc	a0,0x3
ffffffffc02039b4:	ed050513          	addi	a0,a0,-304 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc02039b8:	a8ffc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039bc:	00003697          	auipc	a3,0x3
ffffffffc02039c0:	ef468693          	addi	a3,a3,-268 # ffffffffc02068b0 <default_pmm_manager+0xc58>
ffffffffc02039c4:	00002617          	auipc	a2,0x2
ffffffffc02039c8:	ee460613          	addi	a2,a2,-284 # ffffffffc02058a8 <commands+0x738>
ffffffffc02039cc:	07c00593          	li	a1,124
ffffffffc02039d0:	00003517          	auipc	a0,0x3
ffffffffc02039d4:	eb050513          	addi	a0,a0,-336 # ffffffffc0206880 <default_pmm_manager+0xc28>
...
ffffffffc0203a72:	93268693          	addi	a3,a3,-1742 # ffffffffc02063a0 <default_pmm_manager+0x748>
ffffffffc0203a76:	00002617          	auipc	a2,0x2
ffffffffc0203a7a:	e3260613          	addi	a2,a2,-462 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203a7e:	0c900593          	li	a1,201
ffffffffc0203a82:	00003517          	auipc	a0,0x3
ffffffffc0203a86:	dfe50513          	addi	a0,a0,-514 # ffffffffc0206880 <default_pmm_manager+0xc28>
...
ffffffffc0203ac6:	8de68693          	addi	a3,a3,-1826 # ffffffffc02063a0 <default_pmm_manager+0x748>
ffffffffc0203aca:	00002617          	auipc	a2,0x2
ffffffffc0203ace:	dde60613          	addi	a2,a2,-546 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203ad2:	0cf00593          	li	a1,207
ffffffffc0203ad6:	00003517          	auipc	a0,0x3
ffffffffc0203ada:	daa50513          	addi	a0,a0,-598 # ffffffffc0206880 <default_pmm_manager+0xc28>
...
ffffffffc0203b9a:	e5a50513          	addi	a0,a0,-422 # ffffffffc02069f0 <default_pmm_manager+0xd98>
ffffffffc0203b9e:	de2fc0ef          	jal	ra,ffffffffc0200180 <cprintf>
        }
        assert(vma_below_5 == NULL);
ffffffffc0203ba2:	00003697          	auipc	a3,0x3
ffffffffc0203ba6:	e7668693          	addi	a3,a3,-394 # ffffffffc0206a18 <default_pmm_manager+0xdc0>
ffffffffc0203baa:	00002617          	auipc	a2,0x2
ffffffffc0203bae:	cfe60613          	addi	a2,a2,-770 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203bb2:	0f100593          	li	a1,241
ffffffffc0203bb6:	00003517          	auipc	a0,0x3
ffffffffc0203bba:	cca50513          	addi	a0,a0,-822 # ffffffffc0206880 <default_pmm_manager+0xc28>
...
ffffffffc0203be8:	e4c50513          	addi	a0,a0,-436 # ffffffffc0206a30 <default_pmm_manager+0xdd8>
...
ffffffffc0203cc2:	32aa3a03          	ld	s4,810(s4) # ffffffffc0206fe8 <nbase>
...
ffffffffc0203d7c:	d3050513          	addi	a0,a0,-720 # ffffffffc0206aa8 <default_pmm_manager+0xe50>
...
ffffffffc0203d96:	d3650513          	addi	a0,a0,-714 # ffffffffc0206ac8 <default_pmm_manager+0xe70>
}
...
ffffffffc0203daa:	b6268693          	addi	a3,a3,-1182 # ffffffffc0206908 <default_pmm_manager+0xcb0>
ffffffffc0203dae:	00002617          	auipc	a2,0x2
ffffffffc0203db2:	afa60613          	addi	a2,a2,-1286 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203db6:	0d800593          	li	a1,216
ffffffffc0203dba:	00003517          	auipc	a0,0x3
ffffffffc0203dbe:	ac650513          	addi	a0,a0,-1338 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203dc2:	e84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203dc6:	00003697          	auipc	a3,0x3
ffffffffc0203dca:	bca68693          	addi	a3,a3,-1078 # ffffffffc0206990 <default_pmm_manager+0xd38>
ffffffffc0203dce:	00002617          	auipc	a2,0x2
ffffffffc0203dd2:	ada60613          	addi	a2,a2,-1318 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203dd6:	0e800593          	li	a1,232
ffffffffc0203dda:	00003517          	auipc	a0,0x3
ffffffffc0203dde:	aa650513          	addi	a0,a0,-1370 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203de2:	e64fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2->vm_start == i  && vma2->vm_end == i  + 2);
ffffffffc0203de6:	00003697          	auipc	a3,0x3
ffffffffc0203dea:	bda68693          	addi	a3,a3,-1062 # ffffffffc02069c0 <default_pmm_manager+0xd68>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	aba60613          	addi	a2,a2,-1350 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	a8650513          	addi	a0,a0,-1402 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203e02:	e44fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	aea68693          	addi	a3,a3,-1302 # ffffffffc02068f0 <default_pmm_manager+0xc98>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	a9a60613          	addi	a2,a2,-1382 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203e16:	0d600593          	li	a1,214
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	a6650513          	addi	a0,a0,-1434 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203e22:	e24fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma4 == NULL);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	b4a68693          	addi	a3,a3,-1206 # ffffffffc0206970 <default_pmm_manager+0xd18>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	a7a60613          	addi	a2,a2,-1414 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203e36:	0e400593          	li	a1,228
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	a4650513          	addi	a0,a0,-1466 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203e42:	e04fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma5 == NULL);
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	b3a68693          	addi	a3,a3,-1222 # ffffffffc0206980 <default_pmm_manager+0xd28>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	a5a60613          	addi	a2,a2,-1446 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203e56:	0e600593          	li	a1,230
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	a2650513          	addi	a0,a0,-1498 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203e62:	de4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	ada68693          	addi	a3,a3,-1318 # ffffffffc0206940 <default_pmm_manager+0xce8>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	a3a60613          	addi	a2,a2,-1478 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203e76:	0de00593          	li	a1,222
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	a0650513          	addi	a0,a0,-1530 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203e82:	dc4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	aca68693          	addi	a3,a3,-1334 # ffffffffc0206950 <default_pmm_manager+0xcf8>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	a1a60613          	addi	a2,a2,-1510 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203e96:	0e000593          	li	a1,224
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	9e650513          	addi	a0,a0,-1562 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203ea2:	da4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	aba68693          	addi	a3,a3,-1350 # ffffffffc0206960 <default_pmm_manager+0xd08>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	9fa60613          	addi	a2,a2,-1542 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203eb6:	0e200593          	li	a1,226
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	9c650513          	addi	a0,a0,-1594 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203ec2:	d84fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	c1a68693          	addi	a3,a3,-998 # ffffffffc0206ae0 <default_pmm_manager+0xe88>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	9da60613          	addi	a2,a2,-1574 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203ed6:	10100593          	li	a1,257
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	9a650513          	addi	a0,a0,-1626 # ffffffffc0206880 <default_pmm_manager+0xc28>
    check_mm_struct = mm_create();
...
ffffffffc0203ef2:	4b268693          	addi	a3,a3,1202 # ffffffffc02063a0 <default_pmm_manager+0x748>
ffffffffc0203ef6:	00002617          	auipc	a2,0x2
ffffffffc0203efa:	9b260613          	addi	a2,a2,-1614 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203efe:	10800593          	li	a1,264
ffffffffc0203f02:	00003517          	auipc	a0,0x3
ffffffffc0203f06:	97e50513          	addi	a0,a0,-1666 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203f0a:	d3cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f0e:	00003697          	auipc	a3,0x3
ffffffffc0203f12:	b4268693          	addi	a3,a3,-1214 # ffffffffc0206a50 <default_pmm_manager+0xdf8>
ffffffffc0203f16:	00002617          	auipc	a2,0x2
ffffffffc0203f1a:	99260613          	addi	a2,a2,-1646 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203f1e:	10d00593          	li	a1,269
ffffffffc0203f22:	00003517          	auipc	a0,0x3
ffffffffc0203f26:	95e50513          	addi	a0,a0,-1698 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203f2a:	d1cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(sum == 0);
ffffffffc0203f2e:	00003697          	auipc	a3,0x3
ffffffffc0203f32:	b4268693          	addi	a3,a3,-1214 # ffffffffc0206a70 <default_pmm_manager+0xe18>
ffffffffc0203f36:	00002617          	auipc	a2,0x2
ffffffffc0203f3a:	97260613          	addi	a2,a2,-1678 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203f3e:	11700593          	li	a1,279
ffffffffc0203f42:	00003517          	auipc	a0,0x3
ffffffffc0203f46:	93e50513          	addi	a0,a0,-1730 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203f4a:	cfcfc0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f4e:	00002617          	auipc	a2,0x2
ffffffffc0203f52:	e1260613          	addi	a2,a2,-494 # ffffffffc0205d60 <default_pmm_manager+0x108>
ffffffffc0203f56:	06200593          	li	a1,98
ffffffffc0203f5a:	00002517          	auipc	a0,0x2
ffffffffc0203f5e:	d5e50513          	addi	a0,a0,-674 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc0203f62:	ce4fc0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f66:	00002617          	auipc	a2,0x2
ffffffffc0203f6a:	d2a60613          	addi	a2,a2,-726 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0203f6e:	06900593          	li	a1,105
ffffffffc0203f72:	00002517          	auipc	a0,0x2
ffffffffc0203f76:	d4650513          	addi	a0,a0,-698 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc0203f7a:	cccfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203f7e:	00003697          	auipc	a3,0x3
ffffffffc0203f82:	b0268693          	addi	a3,a3,-1278 # ffffffffc0206a80 <default_pmm_manager+0xe28>
ffffffffc0203f86:	00002617          	auipc	a2,0x2
ffffffffc0203f8a:	92260613          	addi	a2,a2,-1758 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203f8e:	12400593          	li	a1,292
ffffffffc0203f92:	00003517          	auipc	a0,0x3
ffffffffc0203f96:	8ee50513          	addi	a0,a0,-1810 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203f9a:	cacfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203f9e:	00002697          	auipc	a3,0x2
ffffffffc0203fa2:	3f268693          	addi	a3,a3,1010 # ffffffffc0206390 <default_pmm_manager+0x738>
ffffffffc0203fa6:	00002617          	auipc	a2,0x2
ffffffffc0203faa:	90260613          	addi	a2,a2,-1790 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203fae:	10500593          	li	a1,261
ffffffffc0203fb2:	00003517          	auipc	a0,0x3
ffffffffc0203fb6:	8ce50513          	addi	a0,a0,-1842 # ffffffffc0206880 <default_pmm_manager+0xc28>
ffffffffc0203fba:	c8cfc0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(mm != NULL);
ffffffffc0203fbe:	00002697          	auipc	a3,0x2
ffffffffc0203fc2:	3aa68693          	addi	a3,a3,938 # ffffffffc0206368 <default_pmm_manager+0x710>
ffffffffc0203fc6:	00002617          	auipc	a2,0x2
ffffffffc0203fca:	8e260613          	addi	a2,a2,-1822 # ffffffffc02058a8 <commands+0x738>
ffffffffc0203fce:	0c200593          	li	a1,194
ffffffffc0203fd2:	00003517          	auipc	a0,0x3
ffffffffc0203fd6:	8ae50513          	addi	a0,a0,-1874 # ffffffffc0206880 <default_pmm_manager+0xc28>
...
ffffffffc0204080:	acc50513          	addi	a0,a0,-1332 # ffffffffc0206b48 <default_pmm_manager+0xef0>
...
ffffffffc0204092:	a6a50513          	addi	a0,a0,-1430 # ffffffffc0206af8 <default_pmm_manager+0xea0>
...
ffffffffc02040a2:	ad250513          	addi	a0,a0,-1326 # ffffffffc0206b70 <default_pmm_manager+0xf18>
...
ffffffffc02040b2:	a7a50513          	addi	a0,a0,-1414 # ffffffffc0206b28 <default_pmm_manager+0xed0>
...
ffffffffc02040e4:	ab860613          	addi	a2,a2,-1352 # ffffffffc0206b98 <default_pmm_manager+0xf40>
ffffffffc02040e8:	45b5                	li	a1,13
ffffffffc02040ea:	00003517          	auipc	a0,0x3
ffffffffc02040ee:	ace50513          	addi	a0,a0,-1330 # ffffffffc0206bb8 <default_pmm_manager+0xf60>
...
ffffffffc020411e:	ece73703          	ld	a4,-306(a4) # ffffffffc0206fe8 <nbase>
...
ffffffffc0204158:	a7c60613          	addi	a2,a2,-1412 # ffffffffc0206bd0 <default_pmm_manager+0xf78>
ffffffffc020415c:	45d1                	li	a1,20
ffffffffc020415e:	00003517          	auipc	a0,0x3
ffffffffc0204162:	a5a50513          	addi	a0,a0,-1446 # ffffffffc0206bb8 <default_pmm_manager+0xf60>
...
ffffffffc0204174:	b2060613          	addi	a2,a2,-1248 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0204178:	00002517          	auipc	a0,0x2
ffffffffc020417c:	b4050513          	addi	a0,a0,-1216 # ffffffffc0205cb8 <default_pmm_manager+0x60>
...
ffffffffc02041ac:	e4073703          	ld	a4,-448(a4) # ffffffffc0206fe8 <nbase>
...
ffffffffc02041e6:	9ee60613          	addi	a2,a2,-1554 # ffffffffc0206bd0 <default_pmm_manager+0xf78>
ffffffffc02041ea:	45e5                	li	a1,25
ffffffffc02041ec:	00003517          	auipc	a0,0x3
ffffffffc02041f0:	9cc50513          	addi	a0,a0,-1588 # ffffffffc0206bb8 <default_pmm_manager+0xf60>
...
ffffffffc0204202:	a9260613          	addi	a2,a2,-1390 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc0204206:	00002517          	auipc	a0,0x2
ffffffffc020420a:	ab250513          	addi	a0,a0,-1358 # ffffffffc0205cb8 <default_pmm_manager+0x60>
...
ffffffffc0204214:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc0204216:	46e000ef          	jal	ra,ffffffffc0204684 <do_exit>
...
ffffffffc0204250:	46b000ef          	jal	ra,ffffffffc0204eba <memset>
        proc->tf=NULL;
...
ffffffffc020426e:	44d000ef          	jal	ra,ffffffffc0204eba <memset>
    }
    return proc;
}
...
ffffffffc02042d8:	94450513          	addi	a0,a0,-1724 # ffffffffc0206c18 <default_pmm_manager+0xfc0>
ffffffffc02042dc:	ea5fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e0:	00003517          	auipc	a0,0x3
ffffffffc02042e4:	94850513          	addi	a0,a0,-1720 # ffffffffc0206c28 <default_pmm_manager+0xfd0>
...
ffffffffc020433c:	5ce000ef          	jal	ra,ffffffffc020490a <switch_to>
    if (flag) {
...
ffffffffc0204382:	22f75e63          	bge	a4,a5,ffffffffc02045be <do_fork+0x254>
...
ffffffffc0204390:	22050c63          	beqz	a0,ffffffffc02045c8 <do_fork+0x25e>
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc0204394:	4509                	li	a0,2
ffffffffc0204396:	e96fd0ef          	jal	ra,ffffffffc0201a2c <alloc_pages>
    if (page != NULL) {
ffffffffc020439a:	1c050c63          	beqz	a0,ffffffffc0204572 <do_fork+0x208>
    return page - pages + nbase;
...
ffffffffc02043b0:	c3c53503          	ld	a0,-964(a0) # ffffffffc0206fe8 <nbase>
...
ffffffffc02043c4:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043c6:	22e7f363          	bgeu	a5,a4,ffffffffc02045ec <do_fork+0x282>
    assert(current->mm == NULL);
ffffffffc02043ca:	00011317          	auipc	t1,0x11
ffffffffc02043ce:	1e633303          	ld	t1,486(t1) # ffffffffc02155b0 <current>
ffffffffc02043d2:	02833783          	ld	a5,40(t1)
ffffffffc02043d6:	00011717          	auipc	a4,0x11
ffffffffc02043da:	1aa73703          	ld	a4,426(a4) # ffffffffc0215580 <va_pa_offset>
ffffffffc02043de:	96ba                	add	a3,a3,a4
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043e0:	00d9b823          	sd	a3,16(s3)
    assert(current->mm == NULL);
ffffffffc02043e4:	1e079463          	bnez	a5,ffffffffc02045cc <do_fork+0x262>
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043e8:	6789                	lui	a5,0x2
ffffffffc02043ea:	ee078793          	addi	a5,a5,-288 # 1ee0 <kern_entry-0xffffffffc01fe120>
ffffffffc02043ee:	96be                	add	a3,a3,a5
    *(proc->tf) = *tf;
ffffffffc02043f0:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043f2:	0ad9b023          	sd	a3,160(s3)
    *(proc->tf) = *tf;
ffffffffc02043f6:	87b6                	mv	a5,a3
ffffffffc02043f8:	12040893          	addi	a7,s0,288
ffffffffc02043fc:	00063803          	ld	a6,0(a2)
ffffffffc0204400:	6608                	ld	a0,8(a2)
ffffffffc0204402:	6a0c                	ld	a1,16(a2)
ffffffffc0204404:	6e18                	ld	a4,24(a2)
ffffffffc0204406:	0107b023          	sd	a6,0(a5)
ffffffffc020440a:	e788                	sd	a0,8(a5)
ffffffffc020440c:	eb8c                	sd	a1,16(a5)
ffffffffc020440e:	ef98                	sd	a4,24(a5)
ffffffffc0204410:	02060613          	addi	a2,a2,32
ffffffffc0204414:	02078793          	addi	a5,a5,32
ffffffffc0204418:	ff1612e3          	bne	a2,a7,ffffffffc02043fc <do_fork+0x92>
    proc->tf->gpr.a0 = 0;
ffffffffc020441c:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc0204420:	12090663          	beqz	s2,ffffffffc020454c <do_fork+0x1e2>
ffffffffc0204424:	0126b823          	sd	s2,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204428:	00000797          	auipc	a5,0x0
ffffffffc020442c:	e5478793          	addi	a5,a5,-428 # ffffffffc020427c <forkret>
ffffffffc0204430:	02f9b823          	sd	a5,48(s3)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204434:	02d9bc23          	sd	a3,56(s3)
    proc->parent = current;
ffffffffc0204438:	0269b023          	sd	t1,32(s3)
    if (read_csr(sstatus) & SSTATUS_SIE) {
...
ffffffffc0204442:	4901                	li	s2,0
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc0204444:	10079e63          	bnez	a5,ffffffffc0204560 <do_fork+0x1f6>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204448:	00006817          	auipc	a6,0x6
ffffffffc020444c:	c1080813          	addi	a6,a6,-1008 # ffffffffc020a058 <last_pid.1>
...
ffffffffc020445e:	08e55063          	bge	a0,a4,ffffffffc02044de <do_fork+0x174>
    if (last_pid >= next_safe) {
ffffffffc0204462:	00006317          	auipc	t1,0x6
ffffffffc0204466:	bfa30313          	addi	t1,t1,-1030 # ffffffffc020a05c <next_safe.0>
ffffffffc020446a:	00032783          	lw	a5,0(t1)
ffffffffc020446e:	00011417          	auipc	s0,0x11
ffffffffc0204472:	0ba40413          	addi	s0,s0,186 # ffffffffc0215528 <proc_list>
ffffffffc0204476:	06f55c63          	bge	a0,a5,ffffffffc02044ee <do_fork+0x184>
        proc->pid = get_pid();
ffffffffc020447a:	00a9a223          	sw	a0,4(s3)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc020447e:	45a9                	li	a1,10
ffffffffc0204480:	2501                	sext.w	a0,a0
ffffffffc0204482:	5b8000ef          	jal	ra,ffffffffc0204a3a <hash32>
ffffffffc0204486:	02051793          	slli	a5,a0,0x20
ffffffffc020448a:	01c7d513          	srli	a0,a5,0x1c
ffffffffc020448e:	0000d797          	auipc	a5,0xd
ffffffffc0204492:	08a78793          	addi	a5,a5,138 # ffffffffc0211518 <hash_list>
...
ffffffffc02044c0:	c098                	sw	a4,0(s1)
    if (flag) {
ffffffffc02044c2:	08091763          	bnez	s2,ffffffffc0204550 <do_fork+0x1e6>
    wakeup_proc(proc);
ffffffffc02044c6:	854e                	mv	a0,s3
ffffffffc02044c8:	4ac000ef          	jal	ra,ffffffffc0204974 <wakeup_proc>
    ret = proc->pid; 
...
ffffffffc02044da:	6145                	addi	sp,sp,48
ffffffffc02044dc:	8082                	ret
        last_pid = 1;
ffffffffc02044de:	4785                	li	a5,1
ffffffffc02044e0:	00f82023          	sw	a5,0(a6)
        goto inside;
ffffffffc02044e4:	4505                	li	a0,1
ffffffffc02044e6:	00006317          	auipc	t1,0x6
ffffffffc02044ea:	b7630313          	addi	t1,t1,-1162 # ffffffffc020a05c <next_safe.0>
    return listelm->next;
ffffffffc02044ee:	00011417          	auipc	s0,0x11
ffffffffc02044f2:	03a40413          	addi	s0,s0,58 # ffffffffc0215528 <proc_list>
ffffffffc02044f6:	00843e03          	ld	t3,8(s0)
        next_safe = MAX_PID;
ffffffffc02044fa:	6789                	lui	a5,0x2
ffffffffc02044fc:	00f32023          	sw	a5,0(t1)
ffffffffc0204500:	86aa                	mv	a3,a0
ffffffffc0204502:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc0204504:	6e89                	lui	t4,0x2
ffffffffc0204506:	068e0163          	beq	t3,s0,ffffffffc0204568 <do_fork+0x1fe>
ffffffffc020450a:	88ae                	mv	a7,a1
ffffffffc020450c:	87f2                	mv	a5,t3
ffffffffc020450e:	6609                	lui	a2,0x2
ffffffffc0204510:	a811                	j	ffffffffc0204524 <do_fork+0x1ba>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204512:	00e6d663          	bge	a3,a4,ffffffffc020451e <do_fork+0x1b4>
ffffffffc0204516:	00c75463          	bge	a4,a2,ffffffffc020451e <do_fork+0x1b4>
ffffffffc020451a:	863a                	mv	a2,a4
ffffffffc020451c:	4885                	li	a7,1
ffffffffc020451e:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc0204520:	00878d63          	beq	a5,s0,ffffffffc020453a <do_fork+0x1d0>
            if (proc->pid == last_pid) {
ffffffffc0204524:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204528:	fed715e3          	bne	a4,a3,ffffffffc0204512 <do_fork+0x1a8>
                if (++ last_pid >= next_safe) {
ffffffffc020452c:	2685                	addiw	a3,a3,1
ffffffffc020452e:	02c6d463          	bge	a3,a2,ffffffffc0204556 <do_fork+0x1ec>
ffffffffc0204532:	679c                	ld	a5,8(a5)
ffffffffc0204534:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204536:	fe8797e3          	bne	a5,s0,ffffffffc0204524 <do_fork+0x1ba>
ffffffffc020453a:	c581                	beqz	a1,ffffffffc0204542 <do_fork+0x1d8>
ffffffffc020453c:	00d82023          	sw	a3,0(a6)
ffffffffc0204540:	8536                	mv	a0,a3
ffffffffc0204542:	f2088ce3          	beqz	a7,ffffffffc020447a <do_fork+0x110>
ffffffffc0204546:	00c32023          	sw	a2,0(t1)
ffffffffc020454a:	bf05                	j	ffffffffc020447a <do_fork+0x110>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020454c:	8936                	mv	s2,a3
ffffffffc020454e:	bdd9                	j	ffffffffc0204424 <do_fork+0xba>
        intr_enable();
ffffffffc0204550:	86cfc0ef          	jal	ra,ffffffffc02005bc <intr_enable>
ffffffffc0204554:	bf8d                	j	ffffffffc02044c6 <do_fork+0x15c>
                    if (last_pid >= MAX_PID) {
ffffffffc0204556:	01d6c363          	blt	a3,t4,ffffffffc020455c <do_fork+0x1f2>
                        last_pid = 1;
ffffffffc020455a:	4685                	li	a3,1
                    goto repeat;
ffffffffc020455c:	4585                	li	a1,1
ffffffffc020455e:	b765                	j	ffffffffc0204506 <do_fork+0x19c>
        intr_disable();
ffffffffc0204560:	862fc0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204564:	4905                	li	s2,1
ffffffffc0204566:	b5cd                	j	ffffffffc0204448 <do_fork+0xde>
ffffffffc0204568:	cda9                	beqz	a1,ffffffffc02045c2 <do_fork+0x258>
ffffffffc020456a:	00d82023          	sw	a3,0(a6)
    return last_pid;
ffffffffc020456e:	8536                	mv	a0,a3
ffffffffc0204570:	b729                	j	ffffffffc020447a <do_fork+0x110>
    free_pages(kva2page((void *)(proc->kstack)), KSTACKPAGE);
ffffffffc0204572:	0109b683          	ld	a3,16(s3)
    return pa2page(PADDR(kva));
ffffffffc0204576:	c02007b7          	lui	a5,0xc0200
ffffffffc020457a:	0af6e163          	bltu	a3,a5,ffffffffc020461c <do_fork+0x2b2>
ffffffffc020457e:	00011797          	auipc	a5,0x11
ffffffffc0204582:	0027b783          	ld	a5,2(a5) # ffffffffc0215580 <va_pa_offset>
ffffffffc0204586:	40f687b3          	sub	a5,a3,a5
    if (PPN(pa) >= npage) {
ffffffffc020458a:	83b1                	srli	a5,a5,0xc
ffffffffc020458c:	00011717          	auipc	a4,0x11
ffffffffc0204590:	fdc73703          	ld	a4,-36(a4) # ffffffffc0215568 <npage>
ffffffffc0204594:	06e7f863          	bgeu	a5,a4,ffffffffc0204604 <do_fork+0x29a>
    return &pages[PPN(pa) - nbase];
ffffffffc0204598:	00003717          	auipc	a4,0x3
ffffffffc020459c:	a5073703          	ld	a4,-1456(a4) # ffffffffc0206fe8 <nbase>
ffffffffc02045a0:	8f99                	sub	a5,a5,a4
ffffffffc02045a2:	079a                	slli	a5,a5,0x6
ffffffffc02045a4:	00011517          	auipc	a0,0x11
ffffffffc02045a8:	fcc53503          	ld	a0,-52(a0) # ffffffffc0215570 <pages>
ffffffffc02045ac:	953e                	add	a0,a0,a5
ffffffffc02045ae:	4589                	li	a1,2
ffffffffc02045b0:	d0efd0ef          	jal	ra,ffffffffc0201abe <free_pages>
    kfree(proc);
ffffffffc02045b4:	854e                	mv	a0,s3
ffffffffc02045b6:	b48fd0ef          	jal	ra,ffffffffc02018fe <kfree>
    ret = -E_NO_MEM;
ffffffffc02045ba:	5571                	li	a0,-4
    goto fork_out;
ffffffffc02045bc:	bf11                	j	ffffffffc02044d0 <do_fork+0x166>
    int ret = -E_NO_FREE_PROC;
ffffffffc02045be:	556d                	li	a0,-5
ffffffffc02045c0:	bf01                	j	ffffffffc02044d0 <do_fork+0x166>
    return last_pid;
ffffffffc02045c2:	00082503          	lw	a0,0(a6)
ffffffffc02045c6:	bd55                	j	ffffffffc020447a <do_fork+0x110>
    ret = -E_NO_MEM;
ffffffffc02045c8:	5571                	li	a0,-4
    return ret;
ffffffffc02045ca:	b719                	j	ffffffffc02044d0 <do_fork+0x166>
    assert(current->mm == NULL);
ffffffffc02045cc:	00002697          	auipc	a3,0x2
ffffffffc02045d0:	67c68693          	addi	a3,a3,1660 # ffffffffc0206c48 <default_pmm_manager+0xff0>
ffffffffc02045d4:	00001617          	auipc	a2,0x1
ffffffffc02045d8:	2d460613          	addi	a2,a2,724 # ffffffffc02058a8 <commands+0x738>
ffffffffc02045dc:	11700593          	li	a1,279
ffffffffc02045e0:	00002517          	auipc	a0,0x2
ffffffffc02045e4:	68050513          	addi	a0,a0,1664 # ffffffffc0206c60 <default_pmm_manager+0x1008>
ffffffffc02045e8:	e5ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return KADDR(page2pa(page));
ffffffffc02045ec:	00001617          	auipc	a2,0x1
ffffffffc02045f0:	6a460613          	addi	a2,a2,1700 # ffffffffc0205c90 <default_pmm_manager+0x38>
ffffffffc02045f4:	06900593          	li	a1,105
ffffffffc02045f8:	00001517          	auipc	a0,0x1
ffffffffc02045fc:	6c050513          	addi	a0,a0,1728 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc0204600:	e47fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0204604:	00001617          	auipc	a2,0x1
ffffffffc0204608:	75c60613          	addi	a2,a2,1884 # ffffffffc0205d60 <default_pmm_manager+0x108>
ffffffffc020460c:	06200593          	li	a1,98
ffffffffc0204610:	00001517          	auipc	a0,0x1
ffffffffc0204614:	6a850513          	addi	a0,a0,1704 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc0204618:	e2ffb0ef          	jal	ra,ffffffffc0200446 <__panic>
    return pa2page(PADDR(kva));
ffffffffc020461c:	00001617          	auipc	a2,0x1
ffffffffc0204620:	71c60613          	addi	a2,a2,1820 # ffffffffc0205d38 <default_pmm_manager+0xe0>
ffffffffc0204624:	06e00593          	li	a1,110
ffffffffc0204628:	00001517          	auipc	a0,0x1
ffffffffc020462c:	69050513          	addi	a0,a0,1680 # ffffffffc0205cb8 <default_pmm_manager+0x60>
ffffffffc0204630:	e17fb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc020464a:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc020464c:	06f000ef          	jal	ra,ffffffffc0204eba <memset>
...
ffffffffc020466c:	baa78793          	addi	a5,a5,-1110 # ffffffffc0204212 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204670:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc0204672:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc0204674:	cf7ff0ef          	jal	ra,ffffffffc020436a <do_fork>
}
...
ffffffffc020468a:	5f260613          	addi	a2,a2,1522 # ffffffffc0206c78 <default_pmm_manager+0x1020>
ffffffffc020468e:	18000593          	li	a1,384
ffffffffc0204692:	00002517          	auipc	a0,0x2
ffffffffc0204696:	5ce50513          	addi	a0,a0,1486 # ffffffffc0206c60 <default_pmm_manager+0x1008>
do_exit(int error_code) {
ffffffffc020469a:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc020469c:	dabfb0ef          	jal	ra,ffffffffc0200446 <__panic>
...
ffffffffc02046a0:	7179                	addi	sp,sp,-48
ffffffffc02046a2:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc02046a4:	00011797          	auipc	a5,0x11
ffffffffc02046a8:	e8478793          	addi	a5,a5,-380 # ffffffffc0215528 <proc_list>
ffffffffc02046ac:	f406                	sd	ra,40(sp)
ffffffffc02046ae:	f022                	sd	s0,32(sp)
ffffffffc02046b0:	e84a                	sd	s2,16(sp)
ffffffffc02046b2:	e44e                	sd	s3,8(sp)
ffffffffc02046b4:	0000d497          	auipc	s1,0xd
ffffffffc02046b8:	e6448493          	addi	s1,s1,-412 # ffffffffc0211518 <hash_list>
...
ffffffffc02046c4:	e5870713          	addi	a4,a4,-424 # ffffffffc0215518 <name.2>
ffffffffc02046c8:	87a6                	mv	a5,s1
ffffffffc02046ca:	e79c                	sd	a5,8(a5)
ffffffffc02046cc:	e39c                	sd	a5,0(a5)
ffffffffc02046ce:	07c1                	addi	a5,a5,16
ffffffffc02046d0:	fef71de3          	bne	a4,a5,ffffffffc02046ca <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc02046d4:	b47ff0ef          	jal	ra,ffffffffc020421a <alloc_proc>
ffffffffc02046d8:	00011917          	auipc	s2,0x11
ffffffffc02046dc:	ee090913          	addi	s2,s2,-288 # ffffffffc02155b8 <idleproc>
ffffffffc02046e0:	00a93023          	sd	a0,0(s2)
ffffffffc02046e4:	18050d63          	beqz	a0,ffffffffc020487e <proc_init+0x1de>
        panic("cannot alloc idleproc.\n");
    }

    // check the proc structure
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046e8:	07000513          	li	a0,112
ffffffffc02046ec:	962fd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046f0:	07000613          	li	a2,112
ffffffffc02046f4:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc02046f6:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc02046f8:	7c2000ef          	jal	ra,ffffffffc0204eba <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc02046fc:	00093503          	ld	a0,0(s2)
ffffffffc0204700:	85a2                	mv	a1,s0
ffffffffc0204702:	07000613          	li	a2,112
ffffffffc0204706:	03050513          	addi	a0,a0,48
ffffffffc020470a:	7da000ef          	jal	ra,ffffffffc0204ee4 <memcmp>
ffffffffc020470e:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204710:	453d                	li	a0,15
ffffffffc0204712:	93cfd0ef          	jal	ra,ffffffffc020184e <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204716:	463d                	li	a2,15
ffffffffc0204718:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc020471a:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020471c:	79e000ef          	jal	ra,ffffffffc0204eba <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204720:	00093503          	ld	a0,0(s2)
ffffffffc0204724:	463d                	li	a2,15
ffffffffc0204726:	85a2                	mv	a1,s0
ffffffffc0204728:	0b450513          	addi	a0,a0,180
ffffffffc020472c:	7b8000ef          	jal	ra,ffffffffc0204ee4 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204730:	00093783          	ld	a5,0(s2)
ffffffffc0204734:	00011717          	auipc	a4,0x11
ffffffffc0204738:	e2473703          	ld	a4,-476(a4) # ffffffffc0215558 <boot_cr3>
ffffffffc020473c:	77d4                	ld	a3,168(a5)
ffffffffc020473e:	0ee68463          	beq	a3,a4,ffffffffc0204826 <proc_init+0x186>
...
ffffffffc0204744:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;  //内核栈的起始地址。
ffffffffc0204746:	00003717          	auipc	a4,0x3
ffffffffc020474a:	8ba70713          	addi	a4,a4,-1862 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc020474e:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;  //内核栈的起始地址。
ffffffffc0204752:	eb98                	sd	a4,16(a5)
                                              //需要注意以后的其他线程的内核栈都需要通过分配获得
    idleproc->need_resched = 1; //只要此标志为1，马上就调用schedule函数要求调度器切换其他进程执行。
ffffffffc0204754:	4705                	li	a4,1
ffffffffc0204756:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204758:	4641                	li	a2,16
ffffffffc020475a:	4581                	li	a1,0
ffffffffc020475c:	8522                	mv	a0,s0
ffffffffc020475e:	75c000ef          	jal	ra,ffffffffc0204eba <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204762:	463d                	li	a2,15
ffffffffc0204764:	00002597          	auipc	a1,0x2
ffffffffc0204768:	55c58593          	addi	a1,a1,1372 # ffffffffc0206cc0 <default_pmm_manager+0x1068>
ffffffffc020476c:	8522                	mv	a0,s0
ffffffffc020476e:	75e000ef          	jal	ra,ffffffffc0204ecc <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc0204772:	00011717          	auipc	a4,0x11
ffffffffc0204776:	e5670713          	addi	a4,a4,-426 # ffffffffc02155c8 <nr_process>
ffffffffc020477a:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc020477c:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204780:	4601                	li	a2,0
    nr_process ++;
ffffffffc0204782:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204784:	00002597          	auipc	a1,0x2
ffffffffc0204788:	54458593          	addi	a1,a1,1348 # ffffffffc0206cc8 <default_pmm_manager+0x1070>
ffffffffc020478c:	00000517          	auipc	a0,0x0
ffffffffc0204790:	afe50513          	addi	a0,a0,-1282 # ffffffffc020428a <init_main>
    nr_process ++;
ffffffffc0204794:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc0204796:	00011797          	auipc	a5,0x11
ffffffffc020479a:	e0d7bd23          	sd	a3,-486(a5) # ffffffffc02155b0 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc020479e:	e97ff0ef          	jal	ra,ffffffffc0204634 <kernel_thread>
ffffffffc02047a2:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc02047a4:	0ea05963          	blez	a0,ffffffffc0204896 <proc_init+0x1f6>
    if (0 < pid && pid < MAX_PID) {
ffffffffc02047a8:	6789                	lui	a5,0x2
ffffffffc02047aa:	fff5071b          	addiw	a4,a0,-1
ffffffffc02047ae:	17f9                	addi	a5,a5,-2
ffffffffc02047b0:	2501                	sext.w	a0,a0
ffffffffc02047b2:	02e7e363          	bltu	a5,a4,ffffffffc02047d8 <proc_init+0x138>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc02047b6:	45a9                	li	a1,10
ffffffffc02047b8:	282000ef          	jal	ra,ffffffffc0204a3a <hash32>
ffffffffc02047bc:	02051793          	slli	a5,a0,0x20
ffffffffc02047c0:	01c7d693          	srli	a3,a5,0x1c
ffffffffc02047c4:	96a6                	add	a3,a3,s1
ffffffffc02047c6:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc02047c8:	a029                	j	ffffffffc02047d2 <proc_init+0x132>
            if (proc->pid == pid) {
ffffffffc02047ca:	f2c7a703          	lw	a4,-212(a5) # 1f2c <kern_entry-0xffffffffc01fe0d4>
ffffffffc02047ce:	0a870563          	beq	a4,s0,ffffffffc0204878 <proc_init+0x1d8>
    return listelm->next;
ffffffffc02047d2:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc02047d4:	fef69be3          	bne	a3,a5,ffffffffc02047ca <proc_init+0x12a>
    return NULL;
ffffffffc02047d8:	4781                	li	a5,0
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047da:	0b478493          	addi	s1,a5,180
ffffffffc02047de:	4641                	li	a2,16
ffffffffc02047e0:	4581                	li	a1,0
        panic("create init_main failed.\n");
    }

    initproc = find_proc(pid);
ffffffffc02047e2:	00011417          	auipc	s0,0x11
ffffffffc02047e6:	dde40413          	addi	s0,s0,-546 # ffffffffc02155c0 <initproc>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047ea:	8526                	mv	a0,s1
    initproc = find_proc(pid);
ffffffffc02047ec:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02047ee:	6cc000ef          	jal	ra,ffffffffc0204eba <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02047f2:	463d                	li	a2,15
ffffffffc02047f4:	00002597          	auipc	a1,0x2
ffffffffc02047f8:	50458593          	addi	a1,a1,1284 # ffffffffc0206cf8 <default_pmm_manager+0x10a0>
ffffffffc02047fc:	8526                	mv	a0,s1
ffffffffc02047fe:	6ce000ef          	jal	ra,ffffffffc0204ecc <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204802:	00093783          	ld	a5,0(s2)
ffffffffc0204806:	c7e1                	beqz	a5,ffffffffc02048ce <proc_init+0x22e>
ffffffffc0204808:	43dc                	lw	a5,4(a5)
ffffffffc020480a:	e3f1                	bnez	a5,ffffffffc02048ce <proc_init+0x22e>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc020480c:	601c                	ld	a5,0(s0)
ffffffffc020480e:	c3c5                	beqz	a5,ffffffffc02048ae <proc_init+0x20e>
ffffffffc0204810:	43d8                	lw	a4,4(a5)
ffffffffc0204812:	4785                	li	a5,1
ffffffffc0204814:	08f71d63          	bne	a4,a5,ffffffffc02048ae <proc_init+0x20e>
}
ffffffffc0204818:	70a2                	ld	ra,40(sp)
ffffffffc020481a:	7402                	ld	s0,32(sp)
ffffffffc020481c:	64e2                	ld	s1,24(sp)
ffffffffc020481e:	6942                	ld	s2,16(sp)
ffffffffc0204820:	69a2                	ld	s3,8(sp)
ffffffffc0204822:	6145                	addi	sp,sp,48
ffffffffc0204824:	8082                	ret
    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204826:	73d8                	ld	a4,160(a5)
ffffffffc0204828:	ff09                	bnez	a4,ffffffffc0204742 <proc_init+0xa2>
ffffffffc020482a:	f0099ce3          	bnez	s3,ffffffffc0204742 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc020482e:	6394                	ld	a3,0(a5)
ffffffffc0204830:	577d                	li	a4,-1
ffffffffc0204832:	1702                	slli	a4,a4,0x20
ffffffffc0204834:	f0e697e3          	bne	a3,a4,ffffffffc0204742 <proc_init+0xa2>
ffffffffc0204838:	4798                	lw	a4,8(a5)
ffffffffc020483a:	f00714e3          	bnez	a4,ffffffffc0204742 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc020483e:	6b98                	ld	a4,16(a5)
ffffffffc0204840:	f00711e3          	bnez	a4,ffffffffc0204742 <proc_init+0xa2>
ffffffffc0204844:	4f98                	lw	a4,24(a5)
ffffffffc0204846:	2701                	sext.w	a4,a4
ffffffffc0204848:	ee071de3          	bnez	a4,ffffffffc0204742 <proc_init+0xa2>
ffffffffc020484c:	7398                	ld	a4,32(a5)
ffffffffc020484e:	ee071ae3          	bnez	a4,ffffffffc0204742 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc0204852:	7798                	ld	a4,40(a5)
ffffffffc0204854:	ee0717e3          	bnez	a4,ffffffffc0204742 <proc_init+0xa2>
ffffffffc0204858:	0b07a703          	lw	a4,176(a5)
ffffffffc020485c:	8d59                	or	a0,a0,a4
ffffffffc020485e:	0005071b          	sext.w	a4,a0
ffffffffc0204862:	ee0710e3          	bnez	a4,ffffffffc0204742 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc0204866:	00002517          	auipc	a0,0x2
ffffffffc020486a:	44250513          	addi	a0,a0,1090 # ffffffffc0206ca8 <default_pmm_manager+0x1050>
ffffffffc020486e:	913fb0ef          	jal	ra,ffffffffc0200180 <cprintf>
    idleproc->pid = 0;         //通常可以通过pid的赋值来表示线程的创建和身份确定
ffffffffc0204872:	00093783          	ld	a5,0(s2)
ffffffffc0204876:	b5f1                	j	ffffffffc0204742 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc0204878:	f2878793          	addi	a5,a5,-216
ffffffffc020487c:	bfb9                	j	ffffffffc02047da <proc_init+0x13a>
        panic("cannot alloc idleproc.\n");
ffffffffc020487e:	00002617          	auipc	a2,0x2
ffffffffc0204882:	41260613          	addi	a2,a2,1042 # ffffffffc0206c90 <default_pmm_manager+0x1038>
ffffffffc0204886:	19800593          	li	a1,408
ffffffffc020488a:	00002517          	auipc	a0,0x2
ffffffffc020488e:	3d650513          	addi	a0,a0,982 # ffffffffc0206c60 <default_pmm_manager+0x1008>
ffffffffc0204892:	bb5fb0ef          	jal	ra,ffffffffc0200446 <__panic>
        panic("create init_main failed.\n");
ffffffffc0204896:	00002617          	auipc	a2,0x2
ffffffffc020489a:	44260613          	addi	a2,a2,1090 # ffffffffc0206cd8 <default_pmm_manager+0x1080>
ffffffffc020489e:	1b900593          	li	a1,441
ffffffffc02048a2:	00002517          	auipc	a0,0x2
ffffffffc02048a6:	3be50513          	addi	a0,a0,958 # ffffffffc0206c60 <default_pmm_manager+0x1008>
ffffffffc02048aa:	b9dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc02048ae:	00002697          	auipc	a3,0x2
ffffffffc02048b2:	47a68693          	addi	a3,a3,1146 # ffffffffc0206d28 <default_pmm_manager+0x10d0>
ffffffffc02048b6:	00001617          	auipc	a2,0x1
ffffffffc02048ba:	ff260613          	addi	a2,a2,-14 # ffffffffc02058a8 <commands+0x738>
ffffffffc02048be:	1c000593          	li	a1,448
ffffffffc02048c2:	00002517          	auipc	a0,0x2
ffffffffc02048c6:	39e50513          	addi	a0,a0,926 # ffffffffc0206c60 <default_pmm_manager+0x1008>
ffffffffc02048ca:	b7dfb0ef          	jal	ra,ffffffffc0200446 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc02048ce:	00002697          	auipc	a3,0x2
ffffffffc02048d2:	43268693          	addi	a3,a3,1074 # ffffffffc0206d00 <default_pmm_manager+0x10a8>
ffffffffc02048d6:	00001617          	auipc	a2,0x1
ffffffffc02048da:	fd260613          	addi	a2,a2,-46 # ffffffffc02058a8 <commands+0x738>
ffffffffc02048de:	1bf00593          	li	a1,447
ffffffffc02048e2:	00002517          	auipc	a0,0x2
ffffffffc02048e6:	37e50513          	addi	a0,a0,894 # ffffffffc0206c60 <default_pmm_manager+0x1008>
ffffffffc02048ea:	b5dfb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02048ee <cpu_idle>:
...
ffffffffc02048f4:	00011417          	auipc	s0,0x11
ffffffffc02048f8:	cbc40413          	addi	s0,s0,-836 # ffffffffc02155b0 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc02048fc:	6018                	ld	a4,0(s0)
ffffffffc02048fe:	4f1c                	lw	a5,24(a4)
ffffffffc0204900:	2781                	sext.w	a5,a5
ffffffffc0204902:	dff5                	beqz	a5,ffffffffc02048fe <cpu_idle+0x10>
            schedule();
ffffffffc0204904:	0a2000ef          	jal	ra,ffffffffc02049a6 <schedule>
ffffffffc0204908:	bfd5                	j	ffffffffc02048fc <cpu_idle+0xe>

ffffffffc020490a <switch_to>:
.text
...
ffffffffc020490a:	00153023          	sd	ra,0(a0)
    STORE sp, 1*REGBYTES(a0)
ffffffffc020490e:	00253423          	sd	sp,8(a0)
    STORE s0, 2*REGBYTES(a0)
ffffffffc0204912:	e900                	sd	s0,16(a0)
    STORE s1, 3*REGBYTES(a0)
ffffffffc0204914:	ed04                	sd	s1,24(a0)
    STORE s2, 4*REGBYTES(a0)
ffffffffc0204916:	03253023          	sd	s2,32(a0)
    STORE s3, 5*REGBYTES(a0)
ffffffffc020491a:	03353423          	sd	s3,40(a0)
    STORE s4, 6*REGBYTES(a0)
ffffffffc020491e:	03453823          	sd	s4,48(a0)
    STORE s5, 7*REGBYTES(a0)
ffffffffc0204922:	03553c23          	sd	s5,56(a0)
    STORE s6, 8*REGBYTES(a0)
ffffffffc0204926:	05653023          	sd	s6,64(a0)
    STORE s7, 9*REGBYTES(a0)
ffffffffc020492a:	05753423          	sd	s7,72(a0)
    STORE s8, 10*REGBYTES(a0)
ffffffffc020492e:	05853823          	sd	s8,80(a0)
    STORE s9, 11*REGBYTES(a0)
ffffffffc0204932:	05953c23          	sd	s9,88(a0)
    STORE s10, 12*REGBYTES(a0)
ffffffffc0204936:	07a53023          	sd	s10,96(a0)
    STORE s11, 13*REGBYTES(a0)
ffffffffc020493a:	07b53423          	sd	s11,104(a0)

    # restore to's registers
    LOAD ra, 0*REGBYTES(a1)
ffffffffc020493e:	0005b083          	ld	ra,0(a1)
    LOAD sp, 1*REGBYTES(a1)
ffffffffc0204942:	0085b103          	ld	sp,8(a1)
    LOAD s0, 2*REGBYTES(a1)
ffffffffc0204946:	6980                	ld	s0,16(a1)
    LOAD s1, 3*REGBYTES(a1)
ffffffffc0204948:	6d84                	ld	s1,24(a1)
    LOAD s2, 4*REGBYTES(a1)
ffffffffc020494a:	0205b903          	ld	s2,32(a1)
    LOAD s3, 5*REGBYTES(a1)
ffffffffc020494e:	0285b983          	ld	s3,40(a1)
    LOAD s4, 6*REGBYTES(a1)
ffffffffc0204952:	0305ba03          	ld	s4,48(a1)
    LOAD s5, 7*REGBYTES(a1)
ffffffffc0204956:	0385ba83          	ld	s5,56(a1)
    LOAD s6, 8*REGBYTES(a1)
ffffffffc020495a:	0405bb03          	ld	s6,64(a1)
    LOAD s7, 9*REGBYTES(a1)
ffffffffc020495e:	0485bb83          	ld	s7,72(a1)
    LOAD s8, 10*REGBYTES(a1)
ffffffffc0204962:	0505bc03          	ld	s8,80(a1)
    LOAD s9, 11*REGBYTES(a1)
ffffffffc0204966:	0585bc83          	ld	s9,88(a1)
    LOAD s10, 12*REGBYTES(a1)
ffffffffc020496a:	0605bd03          	ld	s10,96(a1)
    LOAD s11, 13*REGBYTES(a1)
ffffffffc020496e:	0685bd83          	ld	s11,104(a1)

    ret
ffffffffc0204972:	8082                	ret

ffffffffc0204974 <wakeup_proc>:
#include <sched.h>
#include <assert.h>
...
ffffffffc0204974:	411c                	lw	a5,0(a0)
ffffffffc0204976:	4705                	li	a4,1
ffffffffc0204978:	37f9                	addiw	a5,a5,-2
ffffffffc020497a:	00f77563          	bgeu	a4,a5,ffffffffc0204984 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc020497e:	4789                	li	a5,2
ffffffffc0204980:	c11c                	sw	a5,0(a0)
ffffffffc0204982:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204984:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204986:	00002697          	auipc	a3,0x2
ffffffffc020498a:	3ca68693          	addi	a3,a3,970 # ffffffffc0206d50 <default_pmm_manager+0x10f8>
ffffffffc020498e:	00001617          	auipc	a2,0x1
ffffffffc0204992:	f1a60613          	addi	a2,a2,-230 # ffffffffc02058a8 <commands+0x738>
ffffffffc0204996:	45a5                	li	a1,9
ffffffffc0204998:	00002517          	auipc	a0,0x2
ffffffffc020499c:	3f850513          	addi	a0,a0,1016 # ffffffffc0206d90 <default_pmm_manager+0x1138>
wakeup_proc(struct proc_struct *proc) {
ffffffffc02049a0:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02049a2:	aa5fb0ef          	jal	ra,ffffffffc0200446 <__panic>

ffffffffc02049a6 <schedule>:
}
...
ffffffffc02049aa:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc02049ac:	100027f3          	csrr	a5,sstatus
ffffffffc02049b0:	8b89                	andi	a5,a5,2
ffffffffc02049b2:	4401                	li	s0,0
ffffffffc02049b4:	efbd                	bnez	a5,ffffffffc0204a32 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc02049b6:	00011897          	auipc	a7,0x11
ffffffffc02049ba:	bfa8b883          	ld	a7,-1030(a7) # ffffffffc02155b0 <current>
ffffffffc02049be:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc02049c2:	00011517          	auipc	a0,0x11
ffffffffc02049c6:	bf653503          	ld	a0,-1034(a0) # ffffffffc02155b8 <idleproc>
ffffffffc02049ca:	04a88e63          	beq	a7,a0,ffffffffc0204a26 <schedule+0x80>
ffffffffc02049ce:	0c888693          	addi	a3,a7,200
ffffffffc02049d2:	00011617          	auipc	a2,0x11
ffffffffc02049d6:	b5660613          	addi	a2,a2,-1194 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc02049da:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
...
ffffffffc02049de:	4809                	li	a6,2
ffffffffc02049e0:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc02049e2:	00c78863          	beq	a5,a2,ffffffffc02049f2 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049e6:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc02049ea:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc02049ee:	03070163          	beq	a4,a6,ffffffffc0204a10 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc02049f2:	fef697e3          	bne	a3,a5,ffffffffc02049e0 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc02049f6:	ed89                	bnez	a1,ffffffffc0204a10 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
...
ffffffffc02049fc:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc02049fe:	00a88463          	beq	a7,a0,ffffffffc0204a06 <schedule+0x60>
            proc_run(next);
ffffffffc0204a02:	8fbff0ef          	jal	ra,ffffffffc02042fc <proc_run>
    if (flag) {
ffffffffc0204a06:	e819                	bnez	s0,ffffffffc0204a1c <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
...
ffffffffc0204a0e:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204a10:	4198                	lw	a4,0(a1)
ffffffffc0204a12:	4789                	li	a5,2
ffffffffc0204a14:	fef712e3          	bne	a4,a5,ffffffffc02049f8 <schedule+0x52>
ffffffffc0204a18:	852e                	mv	a0,a1
ffffffffc0204a1a:	bff9                	j	ffffffffc02049f8 <schedule+0x52>
}
ffffffffc0204a1c:	6402                	ld	s0,0(sp)
ffffffffc0204a1e:	60a2                	ld	ra,8(sp)
ffffffffc0204a20:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204a22:	b9bfb06f          	j	ffffffffc02005bc <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204a26:	00011617          	auipc	a2,0x11
ffffffffc0204a2a:	b0260613          	addi	a2,a2,-1278 # ffffffffc0215528 <proc_list>
ffffffffc0204a2e:	86b2                	mv	a3,a2
ffffffffc0204a30:	b76d                	j	ffffffffc02049da <schedule+0x34>
        intr_disable();
ffffffffc0204a32:	b91fb0ef          	jal	ra,ffffffffc02005c2 <intr_disable>
        return 1;
ffffffffc0204a36:	4405                	li	s0,1
ffffffffc0204a38:	bfbd                	j	ffffffffc02049b6 <schedule+0x10>

ffffffffc0204a3a <hash32>:
 *
...
ffffffffc0204a3a:	9e3707b7          	lui	a5,0x9e370
ffffffffc0204a3e:	2785                	addiw	a5,a5,1
ffffffffc0204a40:	02a7853b          	mulw	a0,a5,a0
    return (hash >> (32 - bits));
ffffffffc0204a44:	02000793          	li	a5,32
ffffffffc0204a48:	9f8d                	subw	a5,a5,a1
}
ffffffffc0204a4a:	00f5553b          	srlw	a0,a0,a5
ffffffffc0204a4e:	8082                	ret

ffffffffc0204a50 <printnum>:
 * */
static void
...
ffffffffc0204a50:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a54:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc0204a56:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a5a:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc0204a5c:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc0204a60:	f022                	sd	s0,32(sp)
ffffffffc0204a62:	ec26                	sd	s1,24(sp)
ffffffffc0204a64:	e84a                	sd	s2,16(sp)
ffffffffc0204a66:	f406                	sd	ra,40(sp)
ffffffffc0204a68:	e44e                	sd	s3,8(sp)
ffffffffc0204a6a:	84aa                	mv	s1,a0
ffffffffc0204a6c:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc0204a6e:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc0204a72:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc0204a74:	03067e63          	bgeu	a2,a6,ffffffffc0204ab0 <printnum+0x60>
ffffffffc0204a78:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc0204a7a:	00805763          	blez	s0,ffffffffc0204a88 <printnum+0x38>
ffffffffc0204a7e:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc0204a80:	85ca                	mv	a1,s2
ffffffffc0204a82:	854e                	mv	a0,s3
ffffffffc0204a84:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc0204a86:	fc65                	bnez	s0,ffffffffc0204a7e <printnum+0x2e>
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a88:	1a02                	slli	s4,s4,0x20
ffffffffc0204a8a:	00002797          	auipc	a5,0x2
ffffffffc0204a8e:	31e78793          	addi	a5,a5,798 # ffffffffc0206da8 <default_pmm_manager+0x1150>
ffffffffc0204a92:	020a5a13          	srli	s4,s4,0x20
ffffffffc0204a96:	9a3e                	add	s4,s4,a5
}
ffffffffc0204a98:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a9a:	000a4503          	lbu	a0,0(s4)
}
ffffffffc0204a9e:	70a2                	ld	ra,40(sp)
ffffffffc0204aa0:	69a2                	ld	s3,8(sp)
ffffffffc0204aa2:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aa4:	85ca                	mv	a1,s2
ffffffffc0204aa6:	87a6                	mv	a5,s1
}
ffffffffc0204aa8:	6942                	ld	s2,16(sp)
ffffffffc0204aaa:	64e2                	ld	s1,24(sp)
ffffffffc0204aac:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204aae:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204ab0:	03065633          	divu	a2,a2,a6
ffffffffc0204ab4:	8722                	mv	a4,s0
ffffffffc0204ab6:	f9bff0ef          	jal	ra,ffffffffc0204a50 <printnum>
ffffffffc0204aba:	b7f9                	j	ffffffffc0204a88 <printnum+0x38>

ffffffffc0204abc <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204abc:	7119                	addi	sp,sp,-128
ffffffffc0204abe:	f4a6                	sd	s1,104(sp)
ffffffffc0204ac0:	f0ca                	sd	s2,96(sp)
ffffffffc0204ac2:	ecce                	sd	s3,88(sp)
ffffffffc0204ac4:	e8d2                	sd	s4,80(sp)
ffffffffc0204ac6:	e4d6                	sd	s5,72(sp)
ffffffffc0204ac8:	e0da                	sd	s6,64(sp)
ffffffffc0204aca:	fc5e                	sd	s7,56(sp)
ffffffffc0204acc:	f06a                	sd	s10,32(sp)
ffffffffc0204ace:	fc86                	sd	ra,120(sp)
ffffffffc0204ad0:	f8a2                	sd	s0,112(sp)
ffffffffc0204ad2:	f862                	sd	s8,48(sp)
ffffffffc0204ad4:	f466                	sd	s9,40(sp)
ffffffffc0204ad6:	ec6e                	sd	s11,24(sp)
ffffffffc0204ad8:	892a                	mv	s2,a0
ffffffffc0204ada:	84ae                	mv	s1,a1
ffffffffc0204adc:	8d32                	mv	s10,a2
ffffffffc0204ade:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204ae0:	02500993          	li	s3,37
            putch(ch, putdat);
        }
        ...
        char padc = ' ';
        width = precision = -1;
ffffffffc0204ae4:	5b7d                	li	s6,-1
ffffffffc0204ae6:	00002a97          	auipc	s5,0x2
ffffffffc0204aea:	2eea8a93          	addi	s5,s5,750 # ffffffffc0206dd4 <default_pmm_manager+0x117c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
...
ffffffffc0204aee:	00002b97          	auipc	s7,0x2
ffffffffc0204af2:	4c2b8b93          	addi	s7,s7,1218 # ffffffffc0206fb0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204af6:	000d4503          	lbu	a0,0(s10)
ffffffffc0204afa:	001d0413          	addi	s0,s10,1
ffffffffc0204afe:	01350a63          	beq	a0,s3,ffffffffc0204b12 <vprintfmt+0x56>
            if (ch == '\0') {
ffffffffc0204b02:	c121                	beqz	a0,ffffffffc0204b42 <vprintfmt+0x86>
            putch(ch, putdat);
ffffffffc0204b04:	85a6                	mv	a1,s1
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b06:	0405                	addi	s0,s0,1
            putch(ch, putdat);
ffffffffc0204b08:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204b0a:	fff44503          	lbu	a0,-1(s0)
ffffffffc0204b0e:	ff351ae3          	bne	a0,s3,ffffffffc0204b02 <vprintfmt+0x46>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b12:	00044603          	lbu	a2,0(s0)
        char padc = ' ';
ffffffffc0204b16:	02000793          	li	a5,32
        lflag = altflag = 0;
ffffffffc0204b1a:	4c81                	li	s9,0
ffffffffc0204b1c:	4881                	li	a7,0
        width = precision = -1;
ffffffffc0204b1e:	5c7d                	li	s8,-1
ffffffffc0204b20:	5dfd                	li	s11,-1
ffffffffc0204b22:	05500513          	li	a0,85
                if (ch < '0' || ch > '9') {
ffffffffc0204b26:	4825                	li	a6,9
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b28:	fdd6059b          	addiw	a1,a2,-35
ffffffffc0204b2c:	0ff5f593          	zext.b	a1,a1
ffffffffc0204b30:	00140d13          	addi	s10,s0,1
ffffffffc0204b34:	04b56263          	bltu	a0,a1,ffffffffc0204b78 <vprintfmt+0xbc>
ffffffffc0204b38:	058a                	slli	a1,a1,0x2
ffffffffc0204b3a:	95d6                	add	a1,a1,s5
ffffffffc0204b3c:	4194                	lw	a3,0(a1)
ffffffffc0204b3e:	96d6                	add	a3,a3,s5
ffffffffc0204b40:	8682                	jr	a3
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204b42:	70e6                	ld	ra,120(sp)
ffffffffc0204b44:	7446                	ld	s0,112(sp)
ffffffffc0204b46:	74a6                	ld	s1,104(sp)
ffffffffc0204b48:	7906                	ld	s2,96(sp)
ffffffffc0204b4a:	69e6                	ld	s3,88(sp)
ffffffffc0204b4c:	6a46                	ld	s4,80(sp)
ffffffffc0204b4e:	6aa6                	ld	s5,72(sp)
ffffffffc0204b50:	6b06                	ld	s6,64(sp)
ffffffffc0204b52:	7be2                	ld	s7,56(sp)
ffffffffc0204b54:	7c42                	ld	s8,48(sp)
ffffffffc0204b56:	7ca2                	ld	s9,40(sp)
...
ffffffffc0204b5e:	8082                	ret
            padc = '0';
ffffffffc0204b60:	87b2                	mv	a5,a2
            goto reswitch;
...
ffffffffc0204b74:	fcb572e3          	bgeu	a0,a1,ffffffffc0204b38 <vprintfmt+0x7c>
            putch('%', putdat);
ffffffffc0204b78:	85a6                	mv	a1,s1
ffffffffc0204b7a:	02500513          	li	a0,37
ffffffffc0204b7e:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204b80:	fff44783          	lbu	a5,-1(s0)
ffffffffc0204b84:	8d22                	mv	s10,s0
ffffffffc0204b86:	f73788e3          	beq	a5,s3,ffffffffc0204af6 <vprintfmt+0x3a>
ffffffffc0204b8a:	ffed4783          	lbu	a5,-2(s10)
ffffffffc0204b8e:	1d7d                	addi	s10,s10,-1
ffffffffc0204b90:	ff379de3          	bne	a5,s3,ffffffffc0204b8a <vprintfmt+0xce>
ffffffffc0204b94:	b78d                	j	ffffffffc0204af6 <vprintfmt+0x3a>
                precision = precision * 10 + ch - '0';
ffffffffc0204b96:	fd060c1b          	addiw	s8,a2,-48
                ch = *fmt;
ffffffffc0204b9a:	00144603          	lbu	a2,1(s0)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b9e:	846a                	mv	s0,s10
                if (ch < '0' || ch > '9') {
ffffffffc0204ba0:	fd06069b          	addiw	a3,a2,-48
                ch = *fmt;
ffffffffc0204ba4:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204ba8:	02d86463          	bltu	a6,a3,ffffffffc0204bd0 <vprintfmt+0x114>
                ch = *fmt;
ffffffffc0204bac:	00144603          	lbu	a2,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204bb0:	002c169b          	slliw	a3,s8,0x2
ffffffffc0204bb4:	0186873b          	addw	a4,a3,s8
ffffffffc0204bb8:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204bbc:	9f2d                	addw	a4,a4,a1
                if (ch < '0' || ch > '9') {
ffffffffc0204bbe:	fd06069b          	addiw	a3,a2,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204bc2:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204bc4:	fd070c1b          	addiw	s8,a4,-48
                ch = *fmt;
ffffffffc0204bc8:	0006059b          	sext.w	a1,a2
                if (ch < '0' || ch > '9') {
ffffffffc0204bcc:	fed870e3          	bgeu	a6,a3,ffffffffc0204bac <vprintfmt+0xf0>
            if (width < 0)
ffffffffc0204bd0:	f40ddce3          	bgez	s11,ffffffffc0204b28 <vprintfmt+0x6c>
                width = precision, precision = -1;
ffffffffc0204bd4:	8de2                	mv	s11,s8
ffffffffc0204bd6:	5c7d                	li	s8,-1
ffffffffc0204bd8:	bf81                	j	ffffffffc0204b28 <vprintfmt+0x6c>
            if (width < 0)
ffffffffc0204bda:	fffdc693          	not	a3,s11
ffffffffc0204bde:	96fd                	srai	a3,a3,0x3f
ffffffffc0204be0:	00ddfdb3          	and	s11,s11,a3
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204be4:	00144603          	lbu	a2,1(s0)
ffffffffc0204be8:	2d81                	sext.w	s11,s11
ffffffffc0204bea:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204bec:	bf35                	j	ffffffffc0204b28 <vprintfmt+0x6c>
            precision = va_arg(ap, int);
ffffffffc0204bee:	000a2c03          	lw	s8,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bf2:	00144603          	lbu	a2,1(s0)
            precision = va_arg(ap, int);
ffffffffc0204bf6:	0a21                	addi	s4,s4,8
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bf8:	846a                	mv	s0,s10
            goto process_precision;
ffffffffc0204bfa:	bfd9                	j	ffffffffc0204bd0 <vprintfmt+0x114>
    if (lflag >= 2) {
ffffffffc0204bfc:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204bfe:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c02:	01174463          	blt	a4,a7,ffffffffc0204c0a <vprintfmt+0x14e>
    else if (lflag) {
ffffffffc0204c06:	1a088e63          	beqz	a7,ffffffffc0204dc2 <vprintfmt+0x306>
        return va_arg(*ap, unsigned long);
ffffffffc0204c0a:	000a3603          	ld	a2,0(s4)
ffffffffc0204c0e:	46c1                	li	a3,16
ffffffffc0204c10:	8a2e                	mv	s4,a1
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204c12:	2781                	sext.w	a5,a5
ffffffffc0204c14:	876e                	mv	a4,s11
ffffffffc0204c16:	85a6                	mv	a1,s1
ffffffffc0204c18:	854a                	mv	a0,s2
ffffffffc0204c1a:	e37ff0ef          	jal	ra,ffffffffc0204a50 <printnum>
            break;
ffffffffc0204c1e:	bde1                	j	ffffffffc0204af6 <vprintfmt+0x3a>
            putch(va_arg(ap, int), putdat);
ffffffffc0204c20:	000a2503          	lw	a0,0(s4)
ffffffffc0204c24:	85a6                	mv	a1,s1
ffffffffc0204c26:	0a21                	addi	s4,s4,8
ffffffffc0204c28:	9902                	jalr	s2
            break;
ffffffffc0204c2a:	b5f1                	j	ffffffffc0204af6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204c2c:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c2e:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c32:	01174463          	blt	a4,a7,ffffffffc0204c3a <vprintfmt+0x17e>
    else if (lflag) {
ffffffffc0204c36:	18088163          	beqz	a7,ffffffffc0204db8 <vprintfmt+0x2fc>
        return va_arg(*ap, unsigned long);
ffffffffc0204c3a:	000a3603          	ld	a2,0(s4)
ffffffffc0204c3e:	46a9                	li	a3,10
ffffffffc0204c40:	8a2e                	mv	s4,a1
ffffffffc0204c42:	bfc1                	j	ffffffffc0204c12 <vprintfmt+0x156>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c44:	00144603          	lbu	a2,1(s0)
            altflag = 1;
ffffffffc0204c48:	4c85                	li	s9,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c4a:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c4c:	bdf1                	j	ffffffffc0204b28 <vprintfmt+0x6c>
            putch(ch, putdat);
ffffffffc0204c4e:	85a6                	mv	a1,s1
ffffffffc0204c50:	02500513          	li	a0,37
ffffffffc0204c54:	9902                	jalr	s2
            break;
ffffffffc0204c56:	b545                	j	ffffffffc0204af6 <vprintfmt+0x3a>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c58:	00144603          	lbu	a2,1(s0)
            lflag ++;
ffffffffc0204c5c:	2885                	addiw	a7,a7,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204c5e:	846a                	mv	s0,s10
            goto reswitch;
ffffffffc0204c60:	b5e1                	j	ffffffffc0204b28 <vprintfmt+0x6c>
    if (lflag >= 2) {
ffffffffc0204c62:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204c64:	008a0593          	addi	a1,s4,8
    if (lflag >= 2) {
ffffffffc0204c68:	01174463          	blt	a4,a7,ffffffffc0204c70 <vprintfmt+0x1b4>
    else if (lflag) {
ffffffffc0204c6c:	14088163          	beqz	a7,ffffffffc0204dae <vprintfmt+0x2f2>
        return va_arg(*ap, unsigned long);
ffffffffc0204c70:	000a3603          	ld	a2,0(s4)
ffffffffc0204c74:	46a1                	li	a3,8
ffffffffc0204c76:	8a2e                	mv	s4,a1
ffffffffc0204c78:	bf69                	j	ffffffffc0204c12 <vprintfmt+0x156>
            putch('0', putdat);
ffffffffc0204c7a:	03000513          	li	a0,48
ffffffffc0204c7e:	85a6                	mv	a1,s1
ffffffffc0204c80:	e03e                	sd	a5,0(sp)
ffffffffc0204c82:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204c84:	85a6                	mv	a1,s1
ffffffffc0204c86:	07800513          	li	a0,120
ffffffffc0204c8a:	9902                	jalr	s2
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c8c:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204c8e:	6782                	ld	a5,0(sp)
ffffffffc0204c90:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204c92:	ff8a3603          	ld	a2,-8(s4)
            goto number;
ffffffffc0204c96:	bfb5                	j	ffffffffc0204c12 <vprintfmt+0x156>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c98:	000a3403          	ld	s0,0(s4)
ffffffffc0204c9c:	008a0713          	addi	a4,s4,8
ffffffffc0204ca0:	e03a                	sd	a4,0(sp)
ffffffffc0204ca2:	14040263          	beqz	s0,ffffffffc0204de6 <vprintfmt+0x32a>
            if (width > 0 && padc != '-') {
ffffffffc0204ca6:	0fb05763          	blez	s11,ffffffffc0204d94 <vprintfmt+0x2d8>
ffffffffc0204caa:	02d00693          	li	a3,45
ffffffffc0204cae:	0cd79163          	bne	a5,a3,ffffffffc0204d70 <vprintfmt+0x2b4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cb2:	00044783          	lbu	a5,0(s0)
ffffffffc0204cb6:	0007851b          	sext.w	a0,a5
ffffffffc0204cba:	cf85                	beqz	a5,ffffffffc0204cf2 <vprintfmt+0x236>
ffffffffc0204cbc:	00140a13          	addi	s4,s0,1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cc0:	05e00413          	li	s0,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cc4:	000c4563          	bltz	s8,ffffffffc0204cce <vprintfmt+0x212>
ffffffffc0204cc8:	3c7d                	addiw	s8,s8,-1
ffffffffc0204cca:	036c0263          	beq	s8,s6,ffffffffc0204cee <vprintfmt+0x232>
                    putch('?', putdat);
ffffffffc0204cce:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204cd0:	0e0c8e63          	beqz	s9,ffffffffc0204dcc <vprintfmt+0x310>
ffffffffc0204cd4:	3781                	addiw	a5,a5,-32
ffffffffc0204cd6:	0ef47b63          	bgeu	s0,a5,ffffffffc0204dcc <vprintfmt+0x310>
                    putch('?', putdat);
ffffffffc0204cda:	03f00513          	li	a0,63
ffffffffc0204cde:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204ce0:	000a4783          	lbu	a5,0(s4)
ffffffffc0204ce4:	3dfd                	addiw	s11,s11,-1
ffffffffc0204ce6:	0a05                	addi	s4,s4,1
ffffffffc0204ce8:	0007851b          	sext.w	a0,a5
ffffffffc0204cec:	ffe1                	bnez	a5,ffffffffc0204cc4 <vprintfmt+0x208>
            for (; width > 0; width --) {
ffffffffc0204cee:	01b05963          	blez	s11,ffffffffc0204d00 <vprintfmt+0x244>
ffffffffc0204cf2:	3dfd                	addiw	s11,s11,-1
                putch(' ', putdat);
ffffffffc0204cf4:	85a6                	mv	a1,s1
ffffffffc0204cf6:	02000513          	li	a0,32
ffffffffc0204cfa:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204cfc:	fe0d9be3          	bnez	s11,ffffffffc0204cf2 <vprintfmt+0x236>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d00:	6a02                	ld	s4,0(sp)
ffffffffc0204d02:	bbd5                	j	ffffffffc0204af6 <vprintfmt+0x3a>
    if (lflag >= 2) {
ffffffffc0204d04:	4705                	li	a4,1
            precision = va_arg(ap, int);
ffffffffc0204d06:	008a0c93          	addi	s9,s4,8
    if (lflag >= 2) {
ffffffffc0204d0a:	01174463          	blt	a4,a7,ffffffffc0204d12 <vprintfmt+0x256>
    else if (lflag) {
ffffffffc0204d0e:	08088d63          	beqz	a7,ffffffffc0204da8 <vprintfmt+0x2ec>
        return va_arg(*ap, long);
ffffffffc0204d12:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204d16:	0a044d63          	bltz	s0,ffffffffc0204dd0 <vprintfmt+0x314>
            num = getint(&ap, lflag);
ffffffffc0204d1a:	8622                	mv	a2,s0
ffffffffc0204d1c:	8a66                	mv	s4,s9
ffffffffc0204d1e:	46a9                	li	a3,10
ffffffffc0204d20:	bdcd                	j	ffffffffc0204c12 <vprintfmt+0x156>
            err = va_arg(ap, int);
ffffffffc0204d22:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d26:	4719                	li	a4,6
            err = va_arg(ap, int);
ffffffffc0204d28:	0a21                	addi	s4,s4,8
            if (err < 0) {
ffffffffc0204d2a:	41f7d69b          	sraiw	a3,a5,0x1f
ffffffffc0204d2e:	8fb5                	xor	a5,a5,a3
ffffffffc0204d30:	40d786bb          	subw	a3,a5,a3
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204d34:	02d74163          	blt	a4,a3,ffffffffc0204d56 <vprintfmt+0x29a>
ffffffffc0204d38:	00369793          	slli	a5,a3,0x3
ffffffffc0204d3c:	97de                	add	a5,a5,s7
ffffffffc0204d3e:	639c                	ld	a5,0(a5)
ffffffffc0204d40:	cb99                	beqz	a5,ffffffffc0204d56 <vprintfmt+0x29a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204d42:	86be                	mv	a3,a5
ffffffffc0204d44:	00000617          	auipc	a2,0x0
ffffffffc0204d48:	1ec60613          	addi	a2,a2,492 # ffffffffc0204f30 <etext+0x28>
ffffffffc0204d4c:	85a6                	mv	a1,s1
ffffffffc0204d4e:	854a                	mv	a0,s2
ffffffffc0204d50:	0ce000ef          	jal	ra,ffffffffc0204e1e <printfmt>
ffffffffc0204d54:	b34d                	j	ffffffffc0204af6 <vprintfmt+0x3a>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204d56:	00002617          	auipc	a2,0x2
ffffffffc0204d5a:	07260613          	addi	a2,a2,114 # ffffffffc0206dc8 <default_pmm_manager+0x1170>
ffffffffc0204d5e:	85a6                	mv	a1,s1
ffffffffc0204d60:	854a                	mv	a0,s2
ffffffffc0204d62:	0bc000ef          	jal	ra,ffffffffc0204e1e <printfmt>
ffffffffc0204d66:	bb41                	j	ffffffffc0204af6 <vprintfmt+0x3a>
                p = "(null)";
ffffffffc0204d68:	00002417          	auipc	s0,0x2
ffffffffc0204d6c:	05840413          	addi	s0,s0,88 # ffffffffc0206dc0 <default_pmm_manager+0x1168>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d70:	85e2                	mv	a1,s8
ffffffffc0204d72:	8522                	mv	a0,s0
ffffffffc0204d74:	e43e                	sd	a5,8(sp)
ffffffffc0204d76:	0e2000ef          	jal	ra,ffffffffc0204e58 <strnlen>
ffffffffc0204d7a:	40ad8dbb          	subw	s11,s11,a0
ffffffffc0204d7e:	01b05b63          	blez	s11,ffffffffc0204d94 <vprintfmt+0x2d8>
                    putch(padc, putdat);
ffffffffc0204d82:	67a2                	ld	a5,8(sp)
ffffffffc0204d84:	00078a1b          	sext.w	s4,a5
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d88:	3dfd                	addiw	s11,s11,-1
                    putch(padc, putdat);
ffffffffc0204d8a:	85a6                	mv	a1,s1
ffffffffc0204d8c:	8552                	mv	a0,s4
ffffffffc0204d8e:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d90:	fe0d9ce3          	bnez	s11,ffffffffc0204d88 <vprintfmt+0x2cc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d94:	00044783          	lbu	a5,0(s0)
ffffffffc0204d98:	00140a13          	addi	s4,s0,1
ffffffffc0204d9c:	0007851b          	sext.w	a0,a5
ffffffffc0204da0:	d3a5                	beqz	a5,ffffffffc0204d00 <vprintfmt+0x244>
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204da2:	05e00413          	li	s0,94
ffffffffc0204da6:	bf39                	j	ffffffffc0204cc4 <vprintfmt+0x208>
        return va_arg(*ap, int);
ffffffffc0204da8:	000a2403          	lw	s0,0(s4)
ffffffffc0204dac:	b7ad                	j	ffffffffc0204d16 <vprintfmt+0x25a>
        return va_arg(*ap, unsigned int);
ffffffffc0204dae:	000a6603          	lwu	a2,0(s4)
ffffffffc0204db2:	46a1                	li	a3,8
ffffffffc0204db4:	8a2e                	mv	s4,a1
ffffffffc0204db6:	bdb1                	j	ffffffffc0204c12 <vprintfmt+0x156>
ffffffffc0204db8:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dbc:	46a9                	li	a3,10
ffffffffc0204dbe:	8a2e                	mv	s4,a1
ffffffffc0204dc0:	bd89                	j	ffffffffc0204c12 <vprintfmt+0x156>
ffffffffc0204dc2:	000a6603          	lwu	a2,0(s4)
ffffffffc0204dc6:	46c1                	li	a3,16
ffffffffc0204dc8:	8a2e                	mv	s4,a1
ffffffffc0204dca:	b5a1                	j	ffffffffc0204c12 <vprintfmt+0x156>
                    putch(ch, putdat);
ffffffffc0204dcc:	9902                	jalr	s2
ffffffffc0204dce:	bf09                	j	ffffffffc0204ce0 <vprintfmt+0x224>
                putch('-', putdat);
ffffffffc0204dd0:	85a6                	mv	a1,s1
ffffffffc0204dd2:	02d00513          	li	a0,45
ffffffffc0204dd6:	e03e                	sd	a5,0(sp)
ffffffffc0204dd8:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204dda:	6782                	ld	a5,0(sp)
ffffffffc0204ddc:	8a66                	mv	s4,s9
ffffffffc0204dde:	40800633          	neg	a2,s0
ffffffffc0204de2:	46a9                	li	a3,10
ffffffffc0204de4:	b53d                	j	ffffffffc0204c12 <vprintfmt+0x156>
            if (width > 0 && padc != '-') {
ffffffffc0204de6:	03b05163          	blez	s11,ffffffffc0204e08 <vprintfmt+0x34c>
ffffffffc0204dea:	02d00693          	li	a3,45
ffffffffc0204dee:	f6d79de3          	bne	a5,a3,ffffffffc0204d68 <vprintfmt+0x2ac>
                p = "(null)";
ffffffffc0204df2:	00002417          	auipc	s0,0x2
ffffffffc0204df6:	fce40413          	addi	s0,s0,-50 # ffffffffc0206dc0 <default_pmm_manager+0x1168>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204dfa:	02800793          	li	a5,40
ffffffffc0204dfe:	02800513          	li	a0,40
ffffffffc0204e02:	00140a13          	addi	s4,s0,1
ffffffffc0204e06:	bd6d                	j	ffffffffc0204cc0 <vprintfmt+0x204>
ffffffffc0204e08:	00002a17          	auipc	s4,0x2
ffffffffc0204e0c:	fb9a0a13          	addi	s4,s4,-71 # ffffffffc0206dc1 <default_pmm_manager+0x1169>
ffffffffc0204e10:	02800513          	li	a0,40
ffffffffc0204e14:	02800793          	li	a5,40
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204e18:	05e00413          	li	s0,94
ffffffffc0204e1c:	b565                	j	ffffffffc0204cc4 <vprintfmt+0x208>

ffffffffc0204e1e <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e1e:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204e20:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e24:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e26:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204e28:	ec06                	sd	ra,24(sp)
ffffffffc0204e2a:	f83a                	sd	a4,48(sp)
ffffffffc0204e2c:	fc3e                	sd	a5,56(sp)
ffffffffc0204e2e:	e0c2                	sd	a6,64(sp)
ffffffffc0204e30:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204e32:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204e34:	c89ff0ef          	jal	ra,ffffffffc0204abc <vprintfmt>
}
ffffffffc0204e38:	60e2                	ld	ra,24(sp)
ffffffffc0204e3a:	6161                	addi	sp,sp,80
ffffffffc0204e3c:	8082                	ret

ffffffffc0204e3e <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204e3e:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204e42:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204e44:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204e46:	cb81                	beqz	a5,ffffffffc0204e56 <strlen+0x18>
        cnt ++;
ffffffffc0204e48:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204e4a:	00a707b3          	add	a5,a4,a0
ffffffffc0204e4e:	0007c783          	lbu	a5,0(a5)
ffffffffc0204e52:	fbfd                	bnez	a5,ffffffffc0204e48 <strlen+0xa>
...
ffffffffc0204e58:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e5a:	e589                	bnez	a1,ffffffffc0204e64 <strnlen+0xc>
ffffffffc0204e5c:	a811                	j	ffffffffc0204e70 <strnlen+0x18>
        cnt ++;
ffffffffc0204e5e:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204e60:	00f58863          	beq	a1,a5,ffffffffc0204e70 <strnlen+0x18>
ffffffffc0204e64:	00f50733          	add	a4,a0,a5
ffffffffc0204e68:	00074703          	lbu	a4,0(a4)
ffffffffc0204e6c:	fb6d                	bnez	a4,ffffffffc0204e5e <strnlen+0x6>
ffffffffc0204e6e:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204e70:	852e                	mv	a0,a1
ffffffffc0204e72:	8082                	ret

ffffffffc0204e74 <strcpy>:
char *
...
#else
    char *p = dst;
ffffffffc0204e74:	87aa                	mv	a5,a0
    while ((*p ++ = *src ++) != '\0')
ffffffffc0204e76:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e7a:	0785                	addi	a5,a5,1
ffffffffc0204e7c:	0585                	addi	a1,a1,1
ffffffffc0204e7e:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204e82:	fb75                	bnez	a4,ffffffffc0204e76 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204e8a:	0005c703          	lbu	a4,0(a1)
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e8e:	cb89                	beqz	a5,ffffffffc0204ea0 <strcmp+0x1a>
        s1 ++, s2 ++;
ffffffffc0204e90:	0505                	addi	a0,a0,1
ffffffffc0204e92:	0585                	addi	a1,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204e94:	fee789e3          	beq	a5,a4,ffffffffc0204e86 <strcmp>
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e98:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e9c:	9d19                	subw	a0,a0,a4
ffffffffc0204e9e:	8082                	ret
ffffffffc0204ea0:	4501                	li	a0,0
ffffffffc0204ea2:	bfed                	j	ffffffffc0204e9c <strcmp+0x16>

ffffffffc0204ea4 <strchr>:
...
ffffffffc0204ea8:	c799                	beqz	a5,ffffffffc0204eb6 <strchr+0x12>
        if (*s == c) {
ffffffffc0204eaa:	00f58763          	beq	a1,a5,ffffffffc0204eb8 <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204eae:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204eb2:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204eb4:	fbfd                	bnez	a5,ffffffffc0204eaa <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204eba:	ca01                	beqz	a2,ffffffffc0204eca <memset+0x10>
ffffffffc0204ebc:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204ebe:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204ec0:	0785                	addi	a5,a5,1
ffffffffc0204ec2:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204ec6:	fec79de3          	bne	a5,a2,ffffffffc0204ec0 <memset+0x6>
    }
    return s;
...
ffffffffc0204ecc <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204ecc:	ca19                	beqz	a2,ffffffffc0204ee2 <memcpy+0x16>
...
ffffffffc0204eda:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204ede:	fec59ae3          	bne	a1,a2,ffffffffc0204ed2 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204ee4:	c205                	beqz	a2,ffffffffc0204f04 <memcmp+0x20>
ffffffffc0204ee6:	962e                	add	a2,a2,a1
ffffffffc0204ee8:	a019                	j	ffffffffc0204eee <memcmp+0xa>
ffffffffc0204eea:	00c58d63          	beq	a1,a2,ffffffffc0204f04 <memcmp+0x20>
        if (*s1 != *s2) {
...
ffffffffc0204ef8:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204efa:	fee788e3          	beq	a5,a4,ffffffffc0204eea <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204efe:	40e7853b          	subw	a0,a5,a4
