...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    80200158:	9d450513          	addi	a0,a0,-1580 # 80200b28 <etext+0xf8>
}
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    8020016c:	0630006f          	j	802009ce <sbi_set_timer>
...
void cons_putc(int c) { sbi_console_putchar((unsigned char)c); }
    ...
    80200176:	03f0006f          	j	802009b4 <sbi_console_putchar>
...
void idt_init(void) {
    ...
    80200188:	38c78793          	addi	a5,a5,908 # 80200510 <__alltraps>
...
void print_regs(struct pushregs *gpr) {
    ...
    8020019e:	9ae50513          	addi	a0,a0,-1618 # 80200b48 <etext+0x118>
void print_regs(struct pushregs *gpr) {
    ...
    80200356:	ade50513          	addi	a0,a0,-1314 # 80200e30 <etext+0x400>
}
...
void print_trapframe(struct trapframe *tf) {
    ...
    8020036a:	ae250513          	addi	a0,a0,-1310 # 80200e48 <etext+0x418>
void print_trapframe(struct trapframe *tf) {
    ...
    802003b6:	af650513          	addi	a0,a0,-1290 # 80200ea8 <etext+0x478>
}
...
void interrupt_handler(struct trapframe *tf) {
    ...
    802003d0:	bbc70713          	addi	a4,a4,-1092 # 80200f88 <etext+0x558>
    ...
    802003e2:	b4250513          	addi	a0,a0,-1214 # 80200f20 <etext+0x4f0>
    802003e6:	b151                	j	8020006a <cprintf>
            cprintf("Hypervisor software interrupt\n");
    802003e8:	00001517          	auipc	a0,0x1
    802003ec:	b1850513          	addi	a0,a0,-1256 # 80200f00 <etext+0x4d0>
    802003f0:	b9ad                	j	8020006a <cprintf>
            cprintf("User software interrupt\n");
    802003f2:	00001517          	auipc	a0,0x1
    802003f6:	ace50513          	addi	a0,a0,-1330 # 80200ec0 <etext+0x490>
    802003fa:	b985                	j	8020006a <cprintf>
            cprintf("Supervisor software interrupt\n");
    802003fc:	00001517          	auipc	a0,0x1
    80200400:	ae450513          	addi	a0,a0,-1308 # 80200ee0 <etext+0x4b0>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    80200446:	b2650513          	addi	a0,a0,-1242 # 80200f68 <etext+0x538>
    ...
    80200456:	aee50513          	addi	a0,a0,-1298 # 80200f40 <etext+0x510>
    ...
    8020046a:	aea50513          	addi	a0,a0,-1302 # 80200f50 <etext+0x520>
    8020046e:	bfdff0ef          	jal	ra,8020006a <cprintf>
}
    80200472:	6402                	ld	s0,0(sp)
    80200474:	60a2                	ld	ra,8(sp)
    80200476:	0141                	addi	sp,sp,16
                sbi_shutdown();  // <sbi.h> 中的关机函数
...
void exception_handler(struct trapframe *tf) {
    ...
    8020049e:	bcdff0ef          	jal	ra,8020006a <cprintf>
            /*(2)输出异常指令地址*/
            cprintf("Exception instruction address: 0x%08x\n", tf->epc);
    802004a2:	10843583          	ld	a1,264(s0)
    802004a6:	00001517          	auipc	a0,0x1
    802004aa:	b2a50513          	addi	a0,a0,-1238 # 80200fd0 <etext+0x5a0>
    ...
    802004d0:	0141                	addi	sp,sp,16
            print_trapframe(tf);
    802004d2:	b571                	j	8020035e <print_trapframe>
            cprintf("Breakpoint\n");
    802004d4:	00001517          	auipc	a0,0x1
    802004d8:	b2450513          	addi	a0,a0,-1244 # 80200ff8 <etext+0x5c8>
    802004dc:	b8fff0ef          	jal	ra,8020006a <cprintf>
             cprintf("Breakpoint instruction address: 0x%08x\n", tf->epc);
...
static inline void trap_dispatch(struct trapframe *tf) {
    ...
    8020050a:	bf85                	j	8020047a <exception_handler>
        interrupt_handler(tf);
    8020050c:	bd4d                	j	802003be <interrupt_handler>
	...
