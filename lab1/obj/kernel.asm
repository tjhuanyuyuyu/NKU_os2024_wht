...
static void cputch(int c, int *cnt) {
    ...
    cons_putc(c);
    80200058:	120000ef          	jal	ra,80200178 <cons_putc>
    (*cnt)++;
...
void clock_init(void) {
    ...
    __asm__ volatile (
    8020013a:	9002                	ebreak
    8020013c:	30200073          	mret
...
void clock_set_next_event(void) { sbi_set_timer(get_cycles() + timebase); }
    ...
    cprintf("++ setup timer interrupts\n");
    80200164:	b719                	j	8020006a <cprintf>
...
void print_regs(struct pushregs *gpr) {
    ...
    8020034e:	d1dff0ef          	jal	ra,8020006a <cprintf>
    cprintf("  t6       0x%08x\n", gpr->t6);
    ...
    cprintf("  t6       0x%08x\n", gpr->t6);
    80200362:	b321                	j	8020006a <cprintf>
...
void print_trapframe(struct trapframe *tf) {
    ...
    cprintf("  cause    0x%08x\n", tf->cause);
    802003c2:	b165                	j	8020006a <cprintf>
...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020040a:	b185                	j	8020006a <cprintf>
void interrupt_handler(struct trapframe *tf) {
    ...
    8020044e:	b931                	j	8020006a <cprintf>
            print_trapframe(tf);
...
void exception_handler(struct trapframe *tf) {
    ...
    80200496:	bd5ff0ef          	jal	ra,8020006a <cprintf>
    ...
    802004a6:	bc5ff0ef          	jal	ra,8020006a <cprintf>
    ...
    802004d0:	b0c50513          	addi	a0,a0,-1268 # 80200fd8 <etext+0x5b0>
    802004d4:	b97ff0ef          	jal	ra,8020006a <cprintf>
            cprintf("its address is:0x%lx\n",tf->epc);
    802004d8:	10843583          	ld	a1,264(s0)
    802004dc:	00001517          	auipc	a0,0x1
    802004e0:	b1c50513          	addi	a0,a0,-1252 # 80200ff8 <etext+0x5d0>
    802004e4:	b87ff0ef          	jal	ra,8020006a <cprintf>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005fc:	a1878793          	addi	a5,a5,-1512 # 80201010 <etext+0x5e8>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    80200658:	9f0a8a93          	addi	s5,s5,-1552 # 80201044 <etext+0x61c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200660:	bc4b8b93          	addi	s7,s7,-1084 # 80201220 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008b6:	78e60613          	addi	a2,a2,1934 # 80201040 <etext+0x618>
    ...
    802008c8:	76c60613          	addi	a2,a2,1900 # 80201030 <etext+0x608>
    ...
    802008da:	75240413          	addi	s0,s0,1874 # 80201028 <etext+0x600>
    ...
    80200964:	6c840413          	addi	s0,s0,1736 # 80201028 <etext+0x600>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    8020097a:	6b3a0a13          	addi	s4,s4,1715 # 80201029 <etext+0x601>
